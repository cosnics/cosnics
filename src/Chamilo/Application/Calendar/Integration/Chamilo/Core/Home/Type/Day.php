 ...
 */
class Day extends BlockRenderer implements ConfigurableInterface, StaticBlockTitleInterface
{
    ...
    protected function getCalendarRenderer()
    {
        if (!isset($this->calendarRenderer))
        {
            $dataProvider = new CalendarRendererProvider(
                new CalendarRendererProviderRepository(), $this->getUser(), $this->getUser(), [], Manager::context()
            );
