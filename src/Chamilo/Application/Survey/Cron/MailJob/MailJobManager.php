...
class MailJobManager
{
    ...
    static function launch_job()
    {
        ...
        {
            $job_count ++;
            $mail_tracker = DataManager :: retrieve_by_id(\Chamilo\Application\Survey\Mail\Storage\DataClass\Mail:: CLASS_NAME , $mail_job->get_publication_mail_tracker_id());
    ...
    static function get_mail_message($type, $publication_id)
    {
        ...
        $url = $base_url . Redirect :: get_link(\Chamilo\Application\Survey\Manager :: APPLICATION_NAME, $parameters);
