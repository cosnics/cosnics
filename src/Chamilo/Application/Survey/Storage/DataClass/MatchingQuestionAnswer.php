...
class MatchingQuestionAnswer extends DataClass
{
    ...
    {
        return $this->get_default_property(self::PROPERTY_MATCH_ID);
    }

    function set_match_id($match_id)
    {
        $this->set_default_property(self::PROPERTY_MATCH_ID, $match_id);
    }
