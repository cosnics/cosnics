<?php
namespace Chamilo\Application\Survey\Rights\Application\Form;
...
class RightsForm extends FormValidator
{
    ...
    public function __construct($form_user, $action, $right)
    {
    ...
    public function setDefaults()
    {
        ...
        $targets_entities = Rights :: get_instance()->get_application_targets_entities($this->right);
    ...
    public function set_rights()
    {
        ...
        $location = $rights_util->get_application_root();
