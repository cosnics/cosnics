...
class CourseCategoryEntity implements NestedRightsEntity
{
    ...
    public function get_xml_feed()
    {
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Application\Weblcms\Admin\Ajax\Manager :: package(),
                \Chamilo\Application\Weblcms\Admin\Ajax\Manager :: PARAM_ACTION => 'course_category'));
