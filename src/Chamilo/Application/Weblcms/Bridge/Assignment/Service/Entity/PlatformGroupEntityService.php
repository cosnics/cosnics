...
use Chamilo\Application\Weblcms\Bridge\Assignment\Table\Entity\PlatformGroup\EntityTable;
...
class PlatformGroupEntityService implements EntityServiceInterface
{
    ...
    {
        $subscribedGroupIds =
            $this->getGroupsTreeTraverser()->findAllSubscribedGroupIdentifiersForUserIdentifier($currentUser->getId());
    ...
    public function getEntityName()
    {
        return $this->translator->trans(
            'PlatformGroupEntity', [], 'Chamilo\Application\Weblcms\Tool\Implementation\Assignment'
        );
    }
    ...
    {
        return $this->translator->trans(
            'PlatformGroupsEntity', [], 'Chamilo\Application\Weblcms\Tool\Implementation\Assignment'
        );
    }
    ...
    )
    {
        return $this->assignmentService->findTargetPlatformGroupsForContentObjectPublication(
            $contentObjectPublication, $this->getTargetPlatformGroupIds($contentObjectPublication), $condition, $offset,
            $count, $orderProperty
        );
    }
