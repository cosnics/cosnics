...
namespace Chamilo\Application\Weblcms\Bridge\LearningPath\Evaluation\DependencyInjection;
...
class DependencyInjectionExtension extends Extension implements ExtensionInterface
{
    ...
    public function load(array $config, ContainerBuilder $container)
    {
        $loader = new XmlFileLoader(
            $container, new FileLocator(
                Path::getInstance()->namespaceToFullPath('Chamilo\Application\Weblcms\Bridge\LearningPath\Evaluation') .
    ...
    {
        return 'chamilo.application.weblcms.bridge.learning_path.evaluation';
    }
}