...
namespace Chamilo\Application\Weblcms\Bridge\LearningPath\ExternalTool\DependencyInjection;
...
class DependencyInjectionExtension extends Extension implements ExtensionInterface
{
    ...
    public function load(array $config, ContainerBuilder $container)
    {
        $loader = new XmlFileLoader(
            $container, new FileLocator(
                Path::getInstance()->namespaceToFullPath('Chamilo\Application\Weblcms\Bridge\LearningPath\ExternalTool') .
    ...
    {
        return 'chamilo.application.weblcms.bridge.learning_path.external_tool';
    }
}