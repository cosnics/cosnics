...
use Chamilo\Application\Weblcms\Service\Publication\PublicationModifier;
...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    public static function areContentObjectsPublished($object_ids)
    {
        ...
        return self::count(ContentObjectPublication::class, new DataClassCountParameters(condition: $condition)) >= 1;
    }
    ...
    )
    {
        ...
        $parameters =
            new DataClassCountParameters(condition: $condition, joins: self::get_content_object_publication_joins());
            ...
            switch ($entity_type)
            {
                ...
                case CoursePlatformGroupEntity::ENTITY_TYPE :
                    ...
                    $groups_resultset = DataManager::retrieves(
                        Group::class, new RetrievesParameters(condition: $group_condition)
                    );
    ...
    public static function get_content_object_publication_attribute($publication_id)
    {
        ...
        $record = self::record(
            ContentObjectPublication::class, new RetrieveParameters(
    ...
    )
    {
        ...
        $retrieveProperties[] = new PropertiesConditionVariable(CourseSetting::class);
    ...
    public static function get_last_visit_date($course_id, $user_id, $module_name = null, $category_id = 0)
    {
        ...
        $course_module_access = self::retrieve(
            ...
            new RetrieveParameters(condition: $condition, orderBy: new OrderBy($order_by))
        );
    ...
    {
        return self::count(
                RightsLocationLockedRight::class, new DataClassCountParameters(
    ...
    public static function is_user_requested_for_course($user_id, $course_id)
    {
        ...
        return (self::count(CourseRequest::class, new DataClassCountParameters(condition: $condition)) > 0);
    }
    ...
    public static function log_course_module_access($course_id, $user_id, $module_name = null, $category_id = 0)
    {
        ...
        $course_module_last_access = self::retrieve(
            CourseModuleLastAccess::class, new RetrieveParameters(condition: $condition)
        );
    ...
    )
    {
        ...
        $retrieveProperties[] = new PropertiesConditionVariable(ContentObjectPublication::class);
     ...
     * @param \Chamilo\Libraries\Storage\Query\OrderBy $order_by
     *
     * @return \Doctrine\Common\Collections\ArrayCollection<CourseCategory>
     */
    ...
    public static function retrieve_course_category_by_code($category_code)
    {
        ...
        return self::retrieve(CourseCategory::class, new RetrieveParameters(condition: $condition));
    }
    ...
    public static function retrieve_course_tool_by_name($course_tool_name)
    {
        ...
        return self::retrieve(CourseTool::class, new RetrieveParameters(condition: $condition));
    }
    ...
    public static function retrieve_course_type_user_category_at_sort($user_id, $course_type_id, $sort, $direction)
    {
        ...
        return self::retrieve(
            ...
            new RetrieveParameters(condition: $condition, orderBy: new OrderBy($object_table_order))
        );
    }
     ...
     * @param int $user_id
     *
     * @return  \Doctrine\Common\Collections\ArrayCollection<\Chamilo\Application\Weblcms\Storage\DataClass\CourseUserCategory>
     */
    ...
    public static function retrieve_introduction_publication($condition)
    {
        ...
        $parameters = new RetrieveParameters(condition: $condition, joins: $joins);
    ...
    public static function retrieve_my_publications(
        $parent_location, $entities, $condition = null, $order_by = null, $offset = 0, $max_objects = - 1,
        $user_id = null
    )
    {
        $condition = self::get_my_publications_condition($parent_location, $entities, $user_id, $condition);
