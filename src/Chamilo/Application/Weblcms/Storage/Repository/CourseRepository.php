...
class CourseRepository implements CourseRepositoryInterface
{
    ...
    function findCourses(array $courseIds)
    {
        ...
        $courses = \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieves(
            Course::class_name(), new DataClassRetrievesParameters($condition)
        );
    ...
    {
        $courses = \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieves(
            Course::class_name(), $retrievesParameters
        );
    ...
    {
        return \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieve_all_courses_from_user($user)
            ->as_array();
    }
    ...
    public function findCourseGroupSubscriptionsByCourseAndGroups($courseId, $groupIds)
    {
        ...
        return \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieves(
            CourseEntityRelation::class_name(), new DataClassRetrievesParameters($condition)
        )->as_array();
    }
    ...
    public function findCourseToolByName($toolName)
    {
        ...
        return \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieve(
            CourseTool :: class_name(), new DataClassRetrieveParameters($condition)
        );
    }
    ...
    {
        return \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieves(CourseTool :: class_name())
            ->as_array();
    }
    ...
    public function findCoursesWithTitularAndCourseSettings(Condition $condition = null)
    {
        ...
        $properties->add(
            new PropertyConditionVariable(
                CourseRelCourseSetting::class_name(), CourseRelCourseSetting::PROPERTY_VALUE
            )
        );

        $properties->add(
            new FixedPropertyConditionVariable(
                User::class_name(), User::PROPERTY_FIRSTNAME, 'titular_firstname'
            )
        );

        $properties->add(
            new FixedPropertyConditionVariable(
                User::class_name(), User::PROPERTY_LASTNAME, 'titular_lastname'
            )
        );
        ...
        $joins->add(
            new Join(
                ...
                new EqualityCondition(
                    new PropertyConditionVariable(Course::class_name(), Course::PROPERTY_ID),
                    new PropertyConditionVariable(
                        CourseRelCourseSetting::class_name(), CourseRelCourseSetting::PROPERTY_COURSE_ID
                    )
                )
            )
        );
        ...
        $joins->add(
            new Join(
                ...
                new EqualityCondition(
                    new PropertyConditionVariable(
                        CourseRelCourseSetting::class_name(), CourseRelCourseSetting::PROPERTY_COURSE_SETTING_ID
                    ),
        ...
        $recordRetrievesParameters = new RecordRetrievesParameters(
            $properties, $condition, null, null, array(), $joins
        );

        $courseRecords = \Chamilo\Application\Weblcms\Course\Storage\DataManager::records(
            Course::class_name(), $recordRetrievesParameters
        );
