...
class AssessmentQuestionAttemptsUserBlock extends AssessmentBlock
{
     ...
     */
    protected function add_additional_information_for_attempt(
        $assessment_attempt, $question_attempt, $counter, $reporting_data
    )
    {
    }
    ...
    public function count_data()
    {
        ...
        $question_id = $this->getRequest()->query->get(Manager::PARAM_QUESTION);
        ...
        $question_attempts = $this->get_question_attempts_from_publication_and_question(
            $this->getPublicationId(), $question_id, $this->get_user_id()
        );
        ...
        foreach ($question_attempts as $question_attempt)
        {
            ...
            // if($assessment_attempt->get_status() == AssessmentAttempt::STATUS_COMPLETED)
            {
                ...
                $reporting_data->add_data_category_row(
                    $counter, Translation::get('Details'),
