...
class WikiMostEditedPageBlock extends ToolBlock
{
    ...
    public function count_data()
    {
        ...
        $reporting_data->set_rows([Translation::get('MostEditedPage'), Translation::get('NumberOfEdits')]);
        ...
        else
        {
            ...
            $url = 'index.php?go=' . \Chamilo\Application\Weblcms\Manager::ACTION_VIEW_COURSE . '&course=' .
                ...
                Manager::PARAM_PUBLICATION_ID . '=' . $this->getPublicationId() . '&tool_action=' .
                Manager::ACTION_VIEW . '&display_action=view_item&selected_cloi=' . $most_edited_page->get_id();

            $reporting_data->add_category(0);
            $reporting_data->add_data_category_row(
                0, Translation::get('MostEditedPage'),
