...
class PublicationDetailBlock extends ToolBlock
{
    ...
    public function count_data()
    {
        ...
        $reporting_data->set_categories([Translation::get('Title'), Translation::get('Description')]);
        ...
        $reporting_data->add_data_category_row(
            Translation::get('Title'), Translation::get('count'), '<a href="' . $url . '">' . $title . '</a>'
        );

        $reporting_data->add_data_category_row(
            Translation::get('Description'), Translation::get('count'),
        ...
        $this->add_reporting_data_from_course_visit_as_category(
            Translation::get('count'), $reporting_data, $course_visit
        );
