...
class MostActiveInactiveLastVisitBlock extends CourseBlock
{
    ...
    public function count_data()
    {
        ...
        $reporting_data->set_rows([Translation::get('TimesAccessed')]);
        ...
        $reporting_data->add_data_category_row(
            Translation::get('Past24hr'), Translation::get('CoursCount'), $past_24_hours
        );

        $reporting_data->add_data_category_row(
            Translation::get('PastWeek'), Translation::get('CoursCount'), $past_week
        );

        $reporting_data->add_data_category_row(
            Translation::get('PastMonth'), Translation::get('CoursCount'), $past_month
        );

        $reporting_data->add_data_category_row(
            Translation::get('PastYear'), Translation::get('CoursCount'), $past_year
        );

        $reporting_data->add_data_category_row(
            Translation::get('MoreThanOneYear'), Translation::get('CoursCount'), $more_than_one_year
        );

        $reporting_data->add_data_category_row(
            Translation::get('NeverAccessed'), Translation::get('CoursCount'), $never
        );
    ...
    {
        return [Html::VIEW_TABLE, Html::VIEW_PIE, Html::VIEW_CSV, Html::VIEW_XLSX, Html::VIEW_XML];
    }
