...
class FilteredCourseList extends Block
    implements ConfigurableInterface, StaticBlockTitleInterface, AsynchronousBlockInterface
{
    ...
    public function getCourseListRenderer()
    {
        ...
        {
            $this->courseListRenderer =
                new \Chamilo\Application\Weblcms\Renderer\CourseList\Type\FilteredCourseListRenderer(
                    $this,
                    $this->getLinkTarget(),
