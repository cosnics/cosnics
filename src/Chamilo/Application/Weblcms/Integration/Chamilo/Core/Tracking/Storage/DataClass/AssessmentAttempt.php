...
class AssessmentAttempt extends AbstractAttempt
{
    ...
    public function get_average_score($publication, $user_id = null)
    {
        ...
        $trackers = DataManager::retrieves(self::class, new StorageParameters(condition: $condition));
        $num = $trackers->count();
    ...
    public function get_times_taken($publication, $user_id = null)
    {
        ...
        return DataManager::count(self::class, new StorageParameters(condition: $condition));
    }
