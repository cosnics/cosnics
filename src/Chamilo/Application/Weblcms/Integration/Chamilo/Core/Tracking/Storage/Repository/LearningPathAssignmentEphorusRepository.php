 ...
 */
class LearningPathAssignmentEphorusRepository extends AssignmentEphorusRepository
{
    /**
     ...
     */
    public function findAssignmentEntriesWithRequestsByTreeNodeData(TreeNodeData $treeNodeData, RecordRetrievesParameters $recordRetrievesParameters)
    {
        $entryConditions = $this->getConditionForTreeNodeData($treeNodeData, $recordRetrievesParameters->getCondition());
     ...
     * @return int
     */
    public function countAssignmentEntriesWithRequestsByTreeNodeData(TreeNodeData $treeNodeData, Condition $condition)
    {
     ...
     * @return Condition
     */
    private function getConditionForTreeNodeData(TreeNodeData $treeNodeData, Condition $condition)
    {
        $conditions = [];
