...
class CourseEntityImporter implements CourseEntityImporterInterface
{
    ...
    public function importCourseEntitiesFromFile(UploadedFile $file)
    {
        ...
        $importedCourseEntityRelations = $importFormat->parseFile($file);
        $this->handleImportedCourseEntityRelations($importedCourseEntityRelations);
    }
     ...
     * @throws \Exception
     */
    protected function handleImportedCourseEntityRelations(array $importedCourseEntityRelations)
    {
        foreach ($importedCourseEntityRelations as $importedCourseEntityRelation)
        {
            $this->handleImportedCourseEntityRelation($importedCourseEntityRelation);
        }
    }
     ...
     * @throws \Exception
     */
    protected function handleImportedCourseEntityRelation(ImportedCourseEntityRelation $importedCourseEntityRelation)
    {
     ...
     * @return bool
     */
    protected function executeCourseEntityRelationAction(ImportedCourseEntityRelation $importedCourseEntityRelation, 
        CourseEntityRelation $courseEntityRelation)
    {
        ...
        elseif ($importedCourseEntityRelation->isRemove())
        {
     ...
     * @throws \Exception
     */
    protected function getCourseEntityRelationFromImported(ImportedCourseEntityRelation $importedCourseEntityRelation, 
        $entityType, $entityId, $course)
    {
        ...
        if ($importedCourseEntityRelation->isUpdate() || $importedCourseEntityRelation->isRemove())
        {
