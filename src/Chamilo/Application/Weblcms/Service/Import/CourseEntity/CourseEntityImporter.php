...
class CourseEntityImporter implements CourseEntityImporterInterface
{
    ...
    protected function handleImportedCourseEntityRelation(ImportedCourseEntityRelation $importedCourseEntityRelation)
    {
        ...
        $courseEntityRelation =
            $this->getCourseEntityRelationFromImported($importedCourseEntityRelation, $entityType, $entityId, $course);
    ...
    protected function getUserFromImportedCourseEntityRelation(
        ImportedCourseUserRelation $importedCourseEntityRelation
    )
    {
