...
class StatisticsViewerComponent extends Manager
{
    ...
    private function retrieve_tracker_items($learning_path_attempt)
    {
        ...
        $condition = new EqualityCondition(
            new PropertyConditionVariable(
                \Chamilo\Application\Weblcms\Integration\Chamilo\Core\Tracking\Storage\DataClass\TreeNodeAttempt::class_name(),
                \Chamilo\Application\Weblcms\Integration\Chamilo\Core\Tracking\Storage\DataClass\TreeNodeAttempt::PROPERTY_LEARNING_PATH_ATTEMPT_ID),
    ...
    private function delete_lpi_attempts_from_item($item_id, $lp_attempt_id)
    {
        ...
        $conditions[] = new EqualityCondition(
            new PropertyConditionVariable(
                \Chamilo\Application\Weblcms\Integration\Chamilo\Core\Tracking\Storage\DataClass\TreeNodeAttempt::class_name(),
                \Chamilo\Application\Weblcms\Integration\Chamilo\Core\Tracking\Storage\DataClass\TreeNodeAttempt::PROPERTY_LEARNING_PATH_ITEM_ID),
