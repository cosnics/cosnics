...
class AssessmentResultsViewerComponent extends Manager implements TableSupport
{
    ...
    {
        $assessment_attempt = DataManager::retrieve_by_id(LearningPathItemAttempt::class_name(), $assessment_attempt_id);
        
        if ($assessment_attempt instanceof LearningPathItemAttempt)
        {
