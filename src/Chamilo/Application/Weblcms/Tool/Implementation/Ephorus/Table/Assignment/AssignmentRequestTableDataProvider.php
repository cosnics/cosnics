...
class AssignmentRequestTableDataProvider extends DataClassTableDataProvider
{
    ...
    public function retrieve_data($condition, $offset, $count, $order_property = null)
    {
        ...
        return DataManager :: retrieve_results_by_assignment(
    ...
    {
        return DataManager :: count_results_content_objects_by_assignment(new DataClassCountParameters($condition));
    }
}
