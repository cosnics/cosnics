...
class RequestManager
{
     ...
     */
    public function findRequestsWithContentObjects(StorageParameters $storageParameters)
    {
        return $this->requestRepository->findRequestsWithContentObjects($storageParameters);
    }
