...
<xsl:stylesheet
    ...
    <xsl:param name="filter">1</xsl:param>
    <xsl:param name="title"></xsl:param>
    <xsl:param name="result_id"></xsl:param>
    <xsl:param name="original"></xsl:param>
    <xsl:param name="found"></xsl:param>
    <xsl:param name="match">60</xsl:param>
    <xsl:param name="authenticity">60</xsl:param>
    <xsl:param name="words">9</xsl:param>
    ...
    <xsl:variable name="check_match_1">95</xsl:variable>
    <xsl:variable name="check_match_2">90</xsl:variable>
    <xsl:variable name="check_match_3">80</xsl:variable>
    <xsl:variable name="check_match_4">70</xsl:variable>
    ...
    <xsl:variable name="check_authenticity_1">95</xsl:variable>
    <xsl:variable name="check_authenticity_2">90</xsl:variable>
    <xsl:variable name="check_authenticity_3">80</xsl:variable>
    <xsl:variable name="check_authenticity_4">70</xsl:variable>
    ...
    <xsl:variable name="check_words_1">75</xsl:variable>
    <xsl:variable name="check_words_2">50</xsl:variable>
    <xsl:variable name="check_words_3">30</xsl:variable>
    <xsl:variable name="check_words_4">20</xsl:variable>
    ...
    <xsl:template match="result">
        <xsl:variable name="fragment_nr">
            <xsl:number count="fragment" level="any"></xsl:number>
        </xsl:variable>
        <xsl:variable name="result_nr">
            <xsl:choose>
                <xsl:when test="$filter=1">
        ...
        <tr>
            ...
            <td>
                <xsl:choose>
                    <xsl:when
                            test="@authenticity &gt;= $check_authenticity and @words &gt;= $check_words and @match &gt;= $check_match">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td class="result_header_origineel" style="word-wrap:break-word; width: 50%;">
                                    <xsl:value-of select="$original" disable-output-escaping="yes"/>
                                </td>
                                <td class="result_header_vergelijk" style="word-wrap:break-word; width: 50%;">
                                    <xsl:value-of select="$found" disable-output-escaping="yes"/>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="result_origineel" style="word-wrap:break-word; width: 50%;">
                                    <xsl:apply-templates select="origineel | addedword"/>
                                </td>
                                <td valign="top" class="result_vergelijk" style="word-wrap:break-word; width: 50%;">
