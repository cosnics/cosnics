...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    public function retrieve_results_by_assignment(DataClassRetrievesParameters $params)
    {
        ...
        $query = 'SELECT ' . $er_alias . '.' . Request :: PROPERTY_ID . ' AS ' . Request :: PROPERTY_REQUEST_ID . ', ' .
             ...
             $er_alias . '.' . Request :: PROPERTY_PROCESS_TYPE . ', ' . $er_alias . '.' .
             Request :: PROPERTY_REQUEST_TIME . ', ' . $er_alias . '.' . Request :: PROPERTY_STATUS . ', ' . $er_alias .
        ...
        if ($order_by != null)
        {
            if ($order_by->get_alias() != null)
            {
                $ob .= $order_by->get_alias() . '.';
            }
            $ob .= $order_by->get_property() . ' ';
