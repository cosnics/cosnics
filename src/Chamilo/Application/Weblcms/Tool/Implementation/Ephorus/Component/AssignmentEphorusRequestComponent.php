...
class AssignmentEphorusRequestComponent extends EphorusRequestComponent
{
    ...
    {
        $translation = Translation :: get('AssignmentSubmission', array(), 'core\tracking');
    ...
    {
        return $this->publication_id; // \common\libraries\platform\session\Request :: get(\application\weblcms\Manager
                                          // ::
                                          // PARAM_PUBLICATION);
    }
}
