...
use Chamilo\Libraries\Mail\Mailer\Platform\Mailer;
 ...
 */
class SubmissionSubmitComponent extends SubmissionSubmitWizardComponent
    implements \Chamilo\Core\Repository\Viewer\ViewerInterface
{
    ...
    public function create_tracker($submitter_id, $repo_object, $submitter_type = null)
    {
        ...
        $assignement_category_id =
            \Chamilo\Core\Repository\Storage\DataManager:: get_repository_category_by_name_or_create_new(
    ...
    protected function submissionTargetSelected()
    {
        return $this->allowGroupSubmissions() &&
            $this->get_parameter(self::PARAM_TARGET_ID) &&
