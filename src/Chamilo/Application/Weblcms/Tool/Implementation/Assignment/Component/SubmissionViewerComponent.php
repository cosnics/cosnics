...
class SubmissionViewerComponent extends SubmissionsManager
{
    ...
    function get_submitter_name()
    {
        ...
        switch ($this->get_submitter_type())
        {
            ...
            case AssignmentSubmission :: SUBMITTER_TYPE_COURSE_GROUP :
                return \Chamilo\Application\Weblcms\Tool\Implementation\CourseGroup\Storage\DataManager :: retrieve_by_id(
    ...
    private function display_navigation_bar()
    {
        ...
        $html[] = '<div class="announcements level_2" style="background-image:url(' .
             Theme :: getInstance()->getCommonImagePath() . 'content_object/introduction.png;width=100%;">';
    ...
    private function generate_submissions_navigator()
    {
        ...
        if ($earlier_submission_url)
        {
            ...
            $html[] = '<img src="' . Theme :: getInstance()->getCommonImagePath() . 'action_prev.png"/>';
            $html[] = Translation :: get('EarlierSubmission');
            $html[] = '</a>';
        }
        else
        {
            $html[] = '<img src="' . Theme :: getInstance()->getCommonImagePath() . 'action_prev_na.png"/>';
            $html[] = Translation :: get('EarlierSubmission');
        }
        ...
        if ($later_submission_url)
        {
            ...
            $html[] = '<img src="' . Theme :: getInstance()->getCommonImagePath() . 'action_next.png"/>';
            $html[] = '</a>';
        }
        else
        {
     ...
     *
     * @return ActionBarRenderer The action bar
     */
        ...
        if ($this->is_allowed(WeblcmsRights :: EDIT_RIGHT))
        {
            ...
            $action_bar->add_common_action(
                new ToolbarItem(
                    ...
                    Theme :: getInstance()->getImagePath() . 'give_feedback.png',
                    $this->get_url(
                        array(
