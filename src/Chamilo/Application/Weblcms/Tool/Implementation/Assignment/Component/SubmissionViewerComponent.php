...
class SubmissionViewerComponent extends SubmissionsManager
{
    ...
    private function find_data()
    {
        ...
        // Submission
        $submissions =
            AssignmentSubmission:: get_data(AssignmentSubmission:: class_name(), null, $condition)->as_array();
    ...
    private function get_feedback_html($feedback_tracker)
    {
        ...
        {
            $html[] =
                '<div class="announcements level_1" style="border-style:solid;border-width:1px;border-color:#CCC;">';
