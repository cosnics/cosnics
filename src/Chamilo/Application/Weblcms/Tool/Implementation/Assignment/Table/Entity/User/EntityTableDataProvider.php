    ...
    extends \Chamilo\Core\Repository\ContentObject\Assignment\Display\Table\Entity\EntityTableDataProvider
{
    ...
    {
        return $this->getTable()->getAssignmentService()->findTargetUsersForContentObjectPublication(
    ...
    {
        return $this->getTable()->getAssignmentService()->countTargetUsersForContentObjectPublication(
            $this->getTable()->getContentObjectPublication(), $this->getTable()->getUserIds(), $condition
        );
    }

    /**
     * @return \Chamilo\Libraries\Format\Table\Table | \Chamilo\Application\Weblcms\Tool\Implementation\Assignment\Table\Entity\User\EntityTable
     */
