 ...
 */
class CourseGroupEntityRenderer extends \Chamilo\Core\Repository\ContentObject\Assignment\Display\Renderer\EntityRenderer
{
    /**
     *
    ...
    {
        return DataManager::retrieve_by_id(CourseGroup::class_name(), $this->getEntityId());
    }
