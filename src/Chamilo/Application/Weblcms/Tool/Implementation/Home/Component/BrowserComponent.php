...
use Chamilo\Application\Weblcms\Tool\Implementation\Home\Renderer\Type\ListHomeRenderer;
...
class BrowserComponent extends Manager
{
    ...
    public function run()
    {
        ...
        $homeRenderer = new ListHomeRenderer(
            $this, $courseTools, $introductionAllowed, $this->getExtensionManager(), $this->get_introduction_text()
        );
    ...
    /**
     * @return HomeRendererExtensionManager
     */
    protected function getExtensionManager()
    {
        return $this->getService(HomeRendererExtensionManager::class);
    }
}
