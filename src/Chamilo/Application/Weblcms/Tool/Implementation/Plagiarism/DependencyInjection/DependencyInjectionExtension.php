...
namespace Chamilo\Application\Weblcms\Tool\Implementation\Plagiarism\DependencyInjection;
...
class DependencyInjectionExtension extends Extension implements ExtensionInterface
{
    ...
    public function load(array $configuration, ContainerBuilder $container)
    {
        ...
        $xmlFileLoader = new XmlFileLoader(
            $container,
            new FileLocator(
                $pathBuilder->getConfigurationPath('Chamilo\Application\Weblcms\Tool\Implementation\Plagiarism') .
                'DependencyInjection'
            )
        );
    ...
    {
        return 'chamilo.application.weblcms.tool.implementation.plagiarism';
    }
