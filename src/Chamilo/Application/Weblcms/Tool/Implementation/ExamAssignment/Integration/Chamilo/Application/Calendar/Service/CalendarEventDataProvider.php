<?php
namespace Chamilo\Application\Weblcms\Tool\Implementation\ExamAssignment\Integration\Chamilo\Application\Calendar\Service;

use Chamilo\Application\Weblcms\Tool\Implementation\ExamAssignment\Integration\Chamilo\Application\Calendar\Repository\CalendarEventDataProviderRepository;
...
class CalendarEventDataProvider extends \Chamilo\Application\Weblcms\Integration\Chamilo\Application\Calendar\Service\CalendarEventDataProvider
{
    ...
    function getCalendarName()
    {
        return Translation::getInstance()->getTranslation(
            ...
            null, 
            'Chamilo\Application\Weblcms\Tool\Implementation\ExamAssignment\Integration\Chamilo\Application\Calendar');
    }
}
