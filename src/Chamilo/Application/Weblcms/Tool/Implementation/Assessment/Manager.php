...
abstract class Manager extends \Chamilo\Application\Weblcms\Tool\Manager implements Categorizable
{
    ...
    const ACTION_ATTEMPT_RESULT_VIEWER = 'attempt_result_viewer';
    const ACTION_SAVE_DOCUMENTS = 'document_saver';
    const ACTION_RAW_EXPORT_RESULTS = 'raw_export_results';
    ...
    public function add_content_object_publication_actions($toolbar, $publication)
    {
        ...
        if ($publication[ContentObject :: PROPERTY_TYPE] == Assessment :: class_name())
        {
            ...
            $complex_display_item->set_image(Theme :: getInstance()->getCommonImagePath() . 'action_next.png');
        ...
        $toolbar->add_item(
            new ToolbarItem(
                ...
                Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'manage_attempts.png',
                $this->get_url(
                    array(
