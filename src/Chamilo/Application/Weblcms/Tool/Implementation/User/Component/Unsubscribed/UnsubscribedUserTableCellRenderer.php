 ...
 */
class UnsubscribedUserTableCellRenderer extends DataClassTableCellRenderer
    implements TableCellRendererActionsColumnSupport
{
    ...
    public function get_actions($user_with_subscription_status)
    {
...

        {
            ...
            $toolbar->add_item(
                new ToolbarItem(
                    Translation::get('SubscribeAsStudent'), new FontAwesomeGlyph('user-graduate'), $subscribe_url,
            ...
            $toolbar->add_item(
                new ToolbarItem(
                    Translation::get('SubscribeAsTeacher'), new FontAwesomeGlyph('user-tie'), $subscribe_url,
                    ToolbarItem::DISPLAY_ICON
                )
            );
        }
        ...
        else
        {
            $toolbar->add_item(
                new ToolbarItem(
                    Translation::get('SubscribeNA'), new FontAwesomeGlyph('plus-circle', array('text-muted')), null,
                    ToolbarItem::DISPLAY_ICON
                )
            );
        }
