...
/*        $component = $this->get_component()->get_tool_browser()->get_parent();
     ...
     */
    protected function getPresencePublication(ContentObjectPublication $contentObjectPublication)
    {
        /** @var \Chamilo\Application\Weblcms\Tool\Implementation\Presence\Component\BrowserComponent $component */
        $component = $this->get_component()->get_tool_browser()->get_parent();

        return $component->getPresencePublication($contentObjectPublication);
    }
}