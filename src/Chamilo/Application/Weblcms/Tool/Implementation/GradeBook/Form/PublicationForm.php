...
namespace Chamilo\Application\Weblcms\Tool\Implementation\GradeBook\Form;
...
/**
 * @package Chamilo\Application\Weblcms\Tool\Implementation\GradeBook\Form
 *
...
class PublicationForm extends ContentObjectPublicationForm
{
    ...
    )
    {
        ...
        parent::__construct(
            'Chamilo\Application\Weblcms\Tool\Implementation\GradeBook',
            $user,
            $form_type,
            $publications,
            $course,
