...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    public static function is_course_group_member($course_group_id, $user_id)
    {
        ...
        return self::count(CourseGroupUserRelation::class, new StorageParameters(condition: $condition)) > 0;
    }
    ...
    public static function retrieve_course_group_by_name($name)
    {
        ...
        return self::retrieve(CourseGroup::class, new StorageParameters(condition: $condition));
    }
     ...
     */
    public static function retrieve_course_group_users(
        $course_group_id, $condition = null, $offset = null, $count = null, $order_property = null
    )
    {
        ...
        {
            $condition = new EqualityCondition(
                new PropertyConditionVariable(User::class, User::PROPERTY_ID), new StaticConditionVariable('-1000')
            );
        }
     ...
     * @param \Chamilo\Libraries\Storage\Query\OrderBy $order_property
     *
     * @return \Doctrine\Common\Collections\ArrayCollection<\user\User>
     */
    public static function retrieve_course_group_users_with_subscription_time(
        $course_group_id, $condition = null, $offset = null, $count = null, $order_property = null
    )
    {
        $propertyConditionVariables = [];
        ...
        $properties = new RetrieveProperties($propertyConditionVariables);
     ...
     */
    public static function retrieve_course_groups_and_subgroups(
        $group_ids, $condition = null, $offset = null, $count = null, $order_by = null
    )
    {
        ...
        $direct_groups = self::retrieves(CourseGroup::class, new StorageParameters(condition: $dg_condition));
        ...
        foreach ($direct_groups as $group)
        {
            ...
            $and_conditions[] = new ComparisonCondition(
                ...
                ComparisonCondition::GREATER_THAN_OR_EQUAL, new StaticConditionVariable($group->get_left_value())
            );

            $and_conditions[] = new ComparisonCondition(
                new PropertyConditionVariable(CourseGroup::class, CourseGroup::PROPERTY_RIGHT_VALUE),
                ComparisonCondition::LESS_THAN_OR_EQUAL, new StaticConditionVariable($group->get_right_value())
            );
