...
class CourseGroupService implements CourseGroupServiceInterface
{
     ...
     * @throws \Exception
     */
    protected function setRightsOnCategoryForCourseGroup(ContentObjectPublicationCategory $publicationCategory, 
        ...
        $rights = array(WeblcmsRights::VIEW_RIGHT, WeblcmsRights::ADD_RIGHT, WeblcmsRights::MANAGE_CATEGORIES_RIGHT))
    {
        ...
        foreach ($rights as $right)
        {
            ...
            {
                throw new \Exception(
                    'Could not set right ' . $right . ' on publication category with id ' . $publicationCategory->getId());
            }
        }
    }
     ...
     * @throws \Exception
     */
    protected function publishForumInCategory(CourseGroup $courseGroup, Forum $forum, 
