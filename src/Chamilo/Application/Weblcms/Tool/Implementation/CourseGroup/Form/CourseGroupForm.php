...
class CourseGroupForm extends FormValidator
{
    ...
    private function check_parent_max_members($parent_course_group, $child_max_size)
    {
        ...
        $course_groups = DataManager::retrieves(CourseGroup::class, new StorageParameters(condition: $condition));
    ...
    public function course_group_name_exists($course_group)
    {
        ...
        $data_set = DataManager::retrieves(CourseGroup::class, new StorageParameters(condition: $condition));
