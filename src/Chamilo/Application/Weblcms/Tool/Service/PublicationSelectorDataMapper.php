...
class PublicationSelectorDataMapper
{
    ...
    public function getContentObjectPublicationsForPublicationSelector($course_id)
    {
        ...
        $publications_set = \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieve_content_object_publications_from_course(
            $course_id, 
            $order_by);
    ...
    public static function getContentObjectPublicationCategoriesForPublicationSelector($course_id, $tools = array())
    {
        ...
        $publication_categories_set = \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieve_content_object_publication_categories_from_course(
            $course_id, 
            $tools, 
            $order_by);
