...
class PublicationSelectorForm
{
    ...
    public function render()
    {
        ...
        $html[] = '<div class="form-row row"><div class="col-12 col-sm-4 col-md-3 col-lg-2 form-label">' .
             $translator->getTranslation('Publications', null, $context) .
             '</div><div id="publications_tree" class="col-12 col-sm-8 col-md-9 col-lg-10 formw"></div></div>';
