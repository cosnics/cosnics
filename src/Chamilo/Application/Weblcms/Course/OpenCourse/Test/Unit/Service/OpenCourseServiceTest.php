...
class OpenCourseServiceTest extends ChamiloTestCase
{
    ...
    {
        $iterator = new DataClassCollection([new Course()]);
    ...
    {
        $course = new Course();
        $resultSet = new DataClassCollection(array(new Role()));
    ...
    public function testIsCourseOpenForUser()
    {
        ...
        $roles = array(new Role());
        $resultSet = new DataClassCollection($roles);
    ...
    public function testRemoveCoursesAsOpenCourse()
    {
        ...
        $this->openCourseRepositoryMock->expects($this->once())->method('removeCoursesAsOpenCourse')->with($courseIds)
            ->will(
                $this->returnValue(true)
            );
