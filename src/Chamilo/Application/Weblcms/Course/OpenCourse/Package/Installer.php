...
use Chamilo\Application\Weblcms\Course\OpenCourse\CourseSettingsController;
use Chamilo\Application\Weblcms\Course\OpenCourse\Rights\CourseManagementRights;
use Chamilo\Application\Weblcms\Course\OpenCourse\Rights\WeblcmsRights;
use Chamilo\Application\Weblcms\Course\OpenCourse\Storage\DataClass\CourseCategory;
...
class Installer extends \Chamilo\Configuration\Package\Action\Installer
{
    ...
    public function extra()
    {
        ...
        if (! \Chamilo\Application\Weblcms\Course\OpenCourse\Request\Rights\Rights :: get_instance()->create_request_root())
        {
            return false;
        }
        else
