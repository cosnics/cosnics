...
class CourseUserGroupFeedComponent extends Manager
{
    ...
    protected function getElements()
    {
        $course = \Chamilo\Application\Weblcms\Course\Storage\DataManager::retrieve_by_id(
            Course::class_name(), $this->getCourseIdentifier()
        );
        ...
        $user_result_set = \Chamilo\Core\User\Storage\DataManager::retrieves(
            User::class_name(), new DataClassRetrievesParameters($user_condition, 100, $this->getOffset(), $order)
        );
