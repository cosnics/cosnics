...
class CourseTypeCourseListRenderer extends CourseListRenderer
{
     ...
     *
     * @var \Doctrine\Common\Collections\ArrayCollection<\Chamilo\Application\Weblcms\CourseType\Storage\DataClass\CourseType>
     */
    ...
    protected function get_selected_course_type_parameter_value()
    {
        ...
        {
            $selected_course_type = $this->getSession()->get(self::PARAM_SELECTED_COURSE_TYPE);
        }
