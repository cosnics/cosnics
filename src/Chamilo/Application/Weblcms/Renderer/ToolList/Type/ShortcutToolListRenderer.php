...
class ShortcutToolListRenderer extends ToolListRenderer
{
    ...
    private function show_tools($tools)
    {
        ...
        foreach ($tools as $tool)
        {
            ...
            $viewUrl = $this->getUrlGenerator()->fromParameters($params, [Manager::PARAM_CATEGORY]);

            $toolButton = new SubButton(
                $title, new IdentGlyph(md5($tool->getContext())), $viewUrl, Button::DISPLAY_ICON_AND_LABEL
            );
