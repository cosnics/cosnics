...
class ListContentObjectPublicationListRenderer extends ContentObjectPublicationListRenderer
{
    ...
    public function renderPublicationHeader($publication)
    {
        ...
        $html[] = '<div class="col-12 col-sm-10 panel-publication-header-title">';
        $html[] = '<h3>';
        ...
        $html[] = '<div class="col-12 col-sm-2 panel-publication-header-actions">';
    ...
    public function renderPublicationFooter($publication)
    {
        ...
        $html[] = '<div class="col-12 col-sm-3 panel-publication-footer-date">';
        $html[] = $this->renderVisiblePublicationDate($publication);
        $html[] = '</div>';

        $html[] = '<div class="col-12 col-sm-6 panel-publication-footer-visibility">';
        $html[] = $this->renderVisibilityData($publication);
        $html[] = '</div>';

        $html[] = '<div class="col-12 col-sm-3 panel-publication-footer-targets">';
    ...
    public function renderHeader()
    {
        ...
        $html[] = '<div class="col-12 col-md-6 table-navigation-actions">';
        ...
        $html[] = '<div class="col-12 col-md-6 table-navigation-search">';
    ...
    public function renderFooter()
    {
        ...
        $html[] = '<div class="col-12 col-md-6 table-navigation-pagination">';
