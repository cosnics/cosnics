 ...
 */
class StructureLocationRoleRepository implements StructureLocationRoleRepositoryInterface
{
    /**
    ...
    public function findRolesForStructureLocation($structureLocationId)
    {
        ...
        return DataManager::retrieves(
            ...
            new DataClassRetrievesParameters(
                $this->getStructureLocationIdCondition($structureLocationId), null, null, array(), $joins
            )
        )->as_array();
    }
    ...
    protected function getStructureLocationIdCondition($structureLocationId)
    {
        return new EqualityCondition(
            new PropertyConditionVariable(
                StructureLocationRole::class_name(), StructureLocationRole::PROPERTY_STRUCTURE_LOCATION_ID
            ),
