...
class StructureLocationRoleServiceTest extends Test
{
    ...
    public function testRemoveRoleFromStructureLocation()
    {
        ...
        $this->structureLocationRoleRepositoryMock->expects($this->once())
            ->method('findStructureLocationRoleByStructureLocationAndRole')
            ->with($structureLocation->getId(), $role->getId())
            ->will($this->returnValue($structureLocationRole));

        $this->structureLocationRoleRepositoryMock->expects($this->once())
            ->method('delete')
            ->with($structureLocationRole)
            ->will($this->returnValue(true));
    ...
    public function testRemoveRoleFromStructureLocationWhenNotAttached()
    {
        ...
        $this->structureLocationRoleRepositoryMock->expects($this->never())
            ->method('delete');
