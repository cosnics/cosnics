...
class StructureLocationServiceTest extends ChamiloTestCase
{
    ...
    public function testCreateStructureLocation()
    {
        ...
        $this->structureLocationRepositoryMock->expects($this->once())->method('create')->with(
                $this->callback(
    ...
    public function testCreateStructureLocationFails()
    {
        ...
        $this->structureLocationRepositoryMock->expects($this->once())->method('create')->will(
    ...
    public function testDeleteStructureLocation()
    {
        ...
        $this->structureLocationRepositoryMock->expects($this->once())->method('delete')->with($structureLocation)
            ->will($this->returnValue(true));
    ...
    {
        $this->structureLocationRepositoryMock->expects($this->once())->method('truncateStructureLocationsAndRoles')
            ->will($this->returnValue(true));
