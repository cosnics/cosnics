...
class AdvancedRightsEditorComponent extends RightsEditorComponent implements TableSupport
{
    ...
    public function display_entity_table($selected_entity)
    {
        ...
        $search_query = $this->action_bar->get_query();
                ...
                if ($location->inherits())
                {
                    ...
                    $action_bar->add_common_action(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getCommonImagePath() . 'action_setting_false_inherit.png',
                            $url,
                            ToolbarItem :: DISPLAY_ICON_AND_LABEL));
                }
                else
                {
                    ...
                    $action_bar->add_common_action(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getCommonImagePath() . 'action_setting_true_inherit.png',
                            $url,
                            ToolbarItem :: DISPLAY_ICON_AND_LABEL));
                }
            }
    ...
    public function get_condition($selected_entity, $search_query, $entity_id = null, $parent_id = null)
    {
        ...
        if (isset($search_query) && $search_query != '')
        {
            ...
            $conditions[] = $this->action_bar->get_conditions($condition_properties);
        }
