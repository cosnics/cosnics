...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
        ...
        $join = new Join(
            ...
            new AndCondition(
                array(
                    ...
                    new EqualityCondition(
                        new PropertyConditionVariable($context_entity_right, $context_entity_right::PROPERTY_LOCATION_ID),
                        new PropertyConditionVariable($context_location::class_name(), $context_location::PROPERTY_ID)))));
    ...
    public function retrieve_target_entities_array($right_id, $context, $location)
    {
        ...
        $properties->add(
            new PropertyConditionVariable($context_entity_right::class_name(), $context_entity_right::PROPERTY_ENTITY_ID));
