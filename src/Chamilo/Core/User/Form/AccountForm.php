...
class AccountForm extends FormValidator
{
    ...
    public function build_basic_form()
    {
        ...
        {
            if (! (($configurationConsulter->get_setting(array(Manager::context(), 'allow_change_placeholder_data')) == 1) && ($this->user->get_firstname() ==
        ...
        {
            if (! (($configurationConsulter->get_setting(array(Manager::context(), 'allow_change_placeholder_data')) == 1) && ($this->user->get_lastname() ==
                 $configurationConsulter->get_setting(array(Manager::context(), 'personal_data_placeholder')))))
            {
        ...
        if (($configurationConsulter->get_setting(array(Manager::context(), 'allow_change_lastname')) == 1) || (($configurationConsulter->get_setting(
            array(Manager::context(), 'allow_change_placeholder_data')) == 1) && ($this->user->get_lastname() ==
             $configurationConsulter->get_setting(array(Manager::context(), 'personal_data_placeholder')))))
        {
            $this->addRule(
        ...
        if (($configurationConsulter->get_setting(array(Manager::context(), 'allow_change_firstname')) == 1) || (($configurationConsulter->get_setting(
            array(Manager::context(), 'allow_change_placeholder_data')) == 1) && ($this->user->get_firstname() ==
             $configurationConsulter->get_setting(array(Manager::context(), 'personal_data_placeholder')))))
        {
            $this->addRule(
        ...
        {
            if (! (($configurationConsulter->get_setting(array(Manager::context(), 'allow_change_placeholder_data')) == 1) && ($this->user->get_email() ==
                 $configurationConsulter->get_setting(array(Manager::context(), 'personal_data_placeholder')))))
            {
        ...
        {
            if ($configurationConsulter->get_setting(array(Manager::context(), 'require_email')) || (($configurationConsulter->get_setting(
                array(Manager::context(), 'allow_change_placeholder_data')) == 1) && ($this->user->get_email() ==
                 $configurationConsulter->get_setting(array(Manager::context(), 'personal_data_placeholder')))))
            {
                $this->addRule(
                    User::PROPERTY_EMAIL, 
