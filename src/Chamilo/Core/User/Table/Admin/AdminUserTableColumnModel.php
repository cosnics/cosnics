...
class AdminUserTableColumnModel extends DataClassTableColumnModel implements TableColumnModelActionsColumnSupport
{
    ...
    public function initialize_columns()
    {
        ...
        $this->add_column(new DataClassPropertyTableColumn(User::class, User::PROPERTY_PLATFORMADMIN));
        $this->add_column(new DataClassPropertyTableColumn(User::class, User::PROPERTY_ACTIVE));
    }
}
