<?php
namespace Chamilo\Core\Metadata\Value\Form\Handler;
...
class ValueEditorFormHandler
{
    ...
    protected function handle_elements(array $export_values = array())
    {
        foreach ($export_values as $fully_qualified_element_name => $export_values_for_element)
        {
            ...
            \Chamilo\Core\Metadata\Element\Storage\DataManager :: create_element_value_by_fully_qualified_element_name_and_value(
                $element_value, 
        ...
        array $export_values_for_element = array())
    {
        foreach ($export_values_for_element as $fully_qualified_attribute_name => $value)
        {
            ...
            $attribute = \Chamilo\Core\Metadata\Storage\DataManager :: retrieve_attribute_by_fully_qualified_attribute_name(
                $fully_qualified_attribute_name);
            
            $has_controlled_vocabulary = \Chamilo\Core\Metadata\Attribute\Storage\DataManager :: attribute_has_controlled_vocabulary(
                $attribute->get_id());
     ...
     * 
     * @param \Chamilo\Core\Metadata\ValueCreator $value_creator
     *
     ...
     * 
     * @return \Chamilo\Core\Metadata\ValueCreator
     */
