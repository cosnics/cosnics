...
use Chamilo\Core\Metadata\Value\Attribute\Form\AttributeValueForm;
...
class CreatorComponent extends Manager
{
    ...
    public function run()
    {
        ...
        $form = new AttributeValueForm(
            $this->get_url(),
            null,
            \Chamilo\Core\Metadata\Storage\DataManager :: retrieve_controlled_vocabulary_from_attribute(
                Request :: get(\Chamilo\Core\Metadata\Attribute\Manager :: PARAM_ATTRIBUTE_ID))->as_array());
        ...
        if ($form->validate())
        {
            try
            {
                ...
                $attribute_id = Request :: get(\Chamilo\Core\Metadata\Attribute\Manager :: PARAM_ATTRIBUTE_ID);
