<?php
namespace Chamilo\Core\Metadata\Value\Storage\DataClass;
...
abstract class ElementValue extends DataClass
{
     ...
     * 
     * @param \Chamilo\Core\Metadata\value\storage\data_class\AttributeValue[] $attribute_values
     */
     ...
     * 
     * @return \Chamilo\Core\Metadata\value\storage\data_class\AttributeValue[]
     */
