<?php
namespace Chamilo\Core\Metadata\ControlledVocabulary\Ajax;
 ...
 */
class ControlledVocabularyFeedComponent extends \Chamilo\Core\Metadata\ControlledVocabulary\Ajax\Manager
{
