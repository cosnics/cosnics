...
class TabAddComponent extends Manager
{
    ...
    public function run()
    {
        ...
        $content[] =
            '<div class="col-xs-12 col-md-' . $column->get_id() . ' portal-column" data-tab-id="' . $tab->get_id() .
            '" data-element-id="' . $column->get_id() . '">';
        ...
        $glyph = new FontAwesomeGlyph(
            'times', array('portal-action-tab-delete'), null, 'fas'
        );
