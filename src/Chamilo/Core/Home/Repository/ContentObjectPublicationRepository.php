...
class ContentObjectPublicationRepository
{
    ...
    public function findFirstContentObjectPublicationByElementId($elementId)
    {
        return DataManager::retrieve(
            ContentObjectPublication::class_name(), new DataClassRetrieveParameters(
                $this->getConditionByElementId(
                    $elementId
                )
            )
        );
    ...
    public function countContentObjectPublicationsByContentObjectId($contentObjectId)
    {
        return DataManager::count(
            ContentObjectPublication::class_name(), $this->getConditionByContentObjectId($contentObjectId)
        );
    }
    ...
    {
        return DataManager::count(
            ContentObjectPublication::class_name(), $this->getConditionByContentObjectIds($contentObjectIds)
        );
    }
    ...
    protected function getConditionByElementId($elementId)
    {
        return new EqualityCondition(
            new PropertyConditionVariable(
                ContentObjectPublication::class_name(), ContentObjectPublication::PROPERTY_ELEMENT_ID
            ),
