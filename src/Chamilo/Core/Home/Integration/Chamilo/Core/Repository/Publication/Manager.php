...
class Manager implements PublicationInterface
{
    ...
    {
        return self::getContentObjectPublicationService()->countContentObjectPublicationsByContentObjectIds($object_ids) >
             0;
    }
        ...
        $offset = null, $order_properties = null)
    {
        ...
        switch ($type)
        {
            case PublicationInterface::ATTRIBUTES_TYPE_OBJECT :
                $publications = self::getContentObjectPublicationService()->getContentObjectPublicationsByContentObjectId(
                    $object_id);
                break;
            case PublicationInterface::ATTRIBUTES_TYPE_USER :
                $publications = self::getContentObjectPublicationService()->getContentObjectPublicationsByContentObjectOwnerId(
                    $object_id);
                break;
            default :
                return array();
