...
include ("../../reporting/viewer/plugin/pchart/class/pScatter.class.php");
...
$myPicture->drawText(
    55, 
    65, 
    "This example demonstrate the importance of graphing data before analysing it. (The line of best fit is the same for all datasets)", 
    array("FontSize" => 12, "R" => 255, "G" => 255, "B" => 255));
