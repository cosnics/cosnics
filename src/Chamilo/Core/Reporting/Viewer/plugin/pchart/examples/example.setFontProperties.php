...
$myPicture->drawText(
    10, 
    13, 
    "setFontProperties() - set default font properties", 
...
$myPicture->setFontProperties(
    array("FontName" => "../fonts/MankSans.ttf", "FontSize" => 30, "R" => 231, "G" => 50, "B" => 36));
$myPicture->drawText(340, 90, "Some big red text");

/* Write some text */
$myPicture->setFontProperties(
    array("FontName" => "../fonts/Silkscreen.ttf", "FontSize" => 6, "R" => 29, "G" => 70, "B" => 111));
