			...
			<td>
				...
				<table
					...
					<tr>
						...
						<td width=16><img src='../resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<a class=smallLinkGrey
							href='../delayedLoader/'>Delayed loader</a></td>
						<td width=16><img src='../resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						...
						<td>
							...
							<div
								...
								<div
									...
									<table>
										<tr>
											<td><img src='../resources/application_view_list.png'
												width=16 height=16 alt='' /></td>
...
foreach ($Tree as $Key => $Element)
{
    ...
    echo "  <td><div class=folder onclick='showExample(" . chr(34) . $Element . chr(34) . ");'>&nbsp;" . $Element .
         "</div></td>\r\n";
    echo " </tr>\r\n";
    echo "</table>\r\n";
}
?>
			...
			<td valign='top' style='padding-top: 5px; font-size: 12px;'>
				<table>
					<tr>
						<td><img src='../resources/chart_bar.png' width=16 height=16
							alt='' /></td>
				...
				<div
					style='display: table-cell; padding: 10px; border: 2px solid #FFFFFF; vertical-align: middle; overflow: auto; background-image: url("resources/dash.png");'>
					<div id=htmlsource
						style='width: 700px; font-size: 13px; font-family: Lucida Console'>

						&lt;html&gt;<br /> &lt;head&gt;<br /> &nbsp;&nbsp; &lt;style&gt;<br />
						&nbsp;&nbsp;&nbsp;&nbsp; div.pChartPicture { border: 0px; }<br />
						&nbsp;&nbsp; &lt;/style&gt;<br /> &lt;/head&gt;<br /> &lt;body&gt;<br />
						&nbsp;&nbsp; &lt;script src="imagemap.js"
						type="text/javascript"&gt;&lt;/script&gt;<br /> &nbsp;&nbsp;
						&lt;img src="draw.php" id="testPicture" alt=""
						class="pChartPicture"/&gt;<br /> &lt;/body&gt;<br />
						&lt;script&gt;<br /> &nbsp;&nbsp;
