...
$myPicture->drawText(
    10, 
    13, 
    "drawThreshold() - draw a treshold in the charting area", 
...
$myPicture->drawXThreshold(
    "Feb", 
    array("ValueIsLabel" => TRUE, "WriteCaption" => TRUE, "Caption" => "Step 1", "Alpha" => 70, "Ticks" => 1));
$myPicture->drawXThreshold(
    2, 
    array("WriteCaption" => TRUE, "Caption" => "Step 2", "Alpha" => 70, "Ticks" => 2, "R" => 0, "G" => 0, "B" => 255));
...
$myPicture->setFontProperties(array("FontName" => "../fonts/Forgotte.ttf", "FontSize" => 11));
$myPicture->drawScale(
    array("XMargin" => 5, "YMargin" => 5, "Floating" => TRUE, "Pos" => SCALE_POS_TOPBOTTOM, "DrawSubTicks" => TRUE));
$myPicture->setShadow(TRUE, array("X" => 1, "Y" => 1, "R" => 0, "G" => 0, "B" => 0, "Alpha" => 20));
