...
include ("../../reporting/viewer/plugin/pchart/class/pBubble.class.php");
...
$myPicture->drawFilledRectangle(
    ...
    430, 
    190, 
    array("R" => 255, "G" => 255, "B" => 255, "Surrounding" => - 50, "Alpha" => 10));
...
$myBubbleChart->drawbubbleChart(
    $bubbleDataSeries, 
    $bubbleWeightSeries, 
    array("DrawBorder" => TRUE, "Surrounding" => 60, "BorderAlpha" => 100));
