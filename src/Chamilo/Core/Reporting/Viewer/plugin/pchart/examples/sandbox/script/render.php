<?php
/*
 * render.php - Sandbox rendering engine Version : 1.1.0 Made by : Jean-Damien POGOLOTTI Last Update : 18/01/11 This
 * file can be distributed under the license you can find at : http://www.pchart.net/license You can find the whole
...
/* ------------------------------------------------------------------------ */
 ...
 include ("../../reporting/viewer/plugin/pchart/class/pData.class.php");
include ("../../reporting/viewer/plugin/pchart/class/pDraw.class.php");
include ("../../reporting/viewer/plugin/pchart/class/pImage.class.php");
...
if ($g_title_enabled == "true")
{
    if ($Mode == "Render")
        $myPicture->setFontProperties(
            array("FontName" => "../../../fonts/" . $g_title_font, "FontSize" => $g_title_font_size));
    else
        echo '$myPicture->setFontProperties(array("FontName"=>"fonts/' . $g_title_font . '","FontSize"=>' .
             $g_title_font_size . '));' . "\r\n";
...
if ($Mode == "Render")
    $myPicture->setFontProperties(
        array("R" => $R, "G" => $G, "B" => $B, "FontName" => "../../../fonts/" . $s_font, "FontSize" => $s_font_size));
else
    echo '$myPicture->setFontProperties(array("R"=>' . $R . ',"G"=>' . $G . ',"B"=>' . $B . ',"FontName"=>"fonts/' .
         $s_font . '","FontSize"=>' . $s_font_size . '));' . "\r\n\r\n";
