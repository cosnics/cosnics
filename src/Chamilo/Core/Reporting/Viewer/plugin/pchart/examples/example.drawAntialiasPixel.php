...
$myPicture->drawGradientArea(
    ...
    230, 
    DIRECTION_VERTICAL, 
    array("StartR" => 180, "StartG" => 193, "StartB" => 91, "EndR" => 120, "EndG" => 137, "EndB" => 72, "Alpha" => 100));
$myPicture->drawGradientArea(
    0, 
    0, 
    700, 
    ...
    array("StartR" => 180, "StartG" => 193, "StartB" => 91, "EndR" => 120, "EndG" => 137, "EndB" => 72, "Alpha" => 20));
$myPicture->drawGradientArea(
    0, 
    0, 
    700, 
...
$myPicture->drawText(
    10, 
    13, 
    "drawAntialiasPixel() - Drawing antialiased pixel with transparency", 
