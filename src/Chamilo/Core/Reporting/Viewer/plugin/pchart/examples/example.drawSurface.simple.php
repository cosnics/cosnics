...
include ("../../reporting/viewer/plugin/pchart/class/pSurface.class.php");
...
$myPicture->drawFilledRectangle(
    ...
    180, 
    80, 
    array("R" => 255, "G" => 255, "B" => 255, "Surrounding" => - 200, "Alpha" => 20));
...
$mySurface->writeXLabels(
    array(
        "Angle" => 45, 
        "Labels" => array("Run 1", "Run 2", "Run 3", "Run 4", "Run 5", "Run 6", "Run 7", "Run 8", "Run 9", "Run 10")));
