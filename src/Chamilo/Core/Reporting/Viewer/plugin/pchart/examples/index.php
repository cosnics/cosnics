...
<table style='border: 2px solid #FFFFFF;'>
		<tr>
			<td>
				<div
					style='font-size: 11px; padding: 2px; color: #FFFFFF; background-color: #666666; border-bottom: 3px solid #484848;'>&nbsp;Navigation</div>
				<table
					style='padding: 1px; background-color: #E0E0E0; border: 1px solid #D0D0D0; border-top: 1px solid #FFFFFF;'>
					<tr>
						<td width=16><img src='resources/application_view_tile.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<b>Examples</b></td>
						<td width=16><img src='resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<a class=smallLinkGrey href='sandbox/'>Sandbox</a></td>
						<td width=16><img src='resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<a class=smallLinkGrey href='delayedLoader/'>Delayed
								loader</a></td>
						<td width=16><img src='resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<a class=smallLinkGrey href='imageMap/'>Image
								Map</a></td>
					</tr>
				</table>
			</td>
			...
			<td valign='top'>
				...
				<table style='border: 2px solid #FFFFFF;'>
					<tr>
						<td>
							<div
								style='font-size: 11px; padding: 2px; color: #FFFFFF; background-color: #666666; border-bottom: 3px solid #484848; width: 222px;'>&nbsp;Release <?php echo $Version; ?></div>
							<div
								...
								<div
									...
									<table>
										<tr>
											<td><img src='resources/application_view_list.png' width=16
												height=16 alt='' /></td>
...
<?php
    ...
    foreach ($Tree as $Key => $Elements)
    {
        ...
        if ($Key != "z_root")
        {
            ...
            echo "  <td><div class=folder id='" . $Key . "_main' onclick='showHideMenu(" . chr(34) . $Key . chr(34) .
                 ");'>&nbsp;" . $Key . "</div></td>\r\n";
            echo " </tr>\r\n";
            echo "</table>\r\n";
            ...
            foreach ($Elements as $SubKey => $Element)
            {
                ...
                echo "  <td><div id='" . $FileName . "'>&nbsp;<a class=smallLinkGrey href='#' onclick='render(" . chr(
                    34) . $FileName . chr(34) . ");'>" . $FileShortName . "</a></div></td>\r\n";
                echo " </tr>\r\n";
            }
            echo "</table>\r\n";
        }
...
<body>
	<div
		...
		<div
			style='background-color: #CB5B5E; color: #FFFFFF; padding: 4px; font-family: tahoma; font-size: 11px;'>
			<B>Warning</B>
		</div>
		<div style='padding: 4px; font-family: tahoma; font-size: 11px;'
			align='justify'>
			It seems that you're not meeting the pChart minimal server
			requirements: <br><br> &nbsp;&nbsp;-&nbsp;PHP must be at least <b>4.x</b><br />
