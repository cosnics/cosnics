...
include ("../../reporting/viewer/plugin/pchart/class/pSpring.class.php");
...
$myPicture->drawGradientArea(
    ...
    20, 
    DIRECTION_VERTICAL, 
    array("StartR" => 0, "StartG" => 0, "StartB" => 0, "EndR" => 100, "EndG" => 100, "EndB" => 100, "Alpha" => 80));
...
$SpringChart->addNode(
    "0", 
    array("Name" => "", "Shape" => NODE_SHAPE_SQUARE, "FreeZone" => 60, "Size" => 20, "NodeType" => NODE_TYPE_CENTRAL));
...
$SpringChart->setNodesColor(
    array(0), 
    array("R" => 215, "G" => 163, "B" => 121, "BorderR" => 166, "BorderG" => 115, "BorderB" => 74));
