<?php
/*
 * pCache - speed up the rendering by caching up the pictures Version : 2.1.3 Made by : Jean-Damien POGOLOTTI Last
 * Update : 09/09/11 This file can be distributed under the license you can find at : http://www.pchart.net/license You
 * can find the whole class documentation on the pChart web site.
 */
