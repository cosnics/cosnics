<?php
/*
 * pScatter - class to draw scatter charts Version : 2.1.3 Made by : Jean-Damien POGOLOTTI Last Update : 09/09/11 This
        ...
        if ($Data["Axis"][$AxisID]["Identity"] == AXIS_X)
        {
            ...
            foreach ($Values as $Key => $Value)
            {
                if ($Value == VOID)
                    ...
                    $Result[] = $this->pChartObject->GraphAreaX1 + $Data["Axis"][$AxisID]["Margin"] +
        ...
        else
        {
            ...
            foreach ($Values as $Key => $Value)
            {
                if ($Value == VOID)
                    ...
                    $Result[] = $this->pChartObject->GraphAreaY2 - $Data["Axis"][$AxisID]["Margin"] -
                         ($Step * ($Value - $Data["Axis"][$AxisID]["ScaleMin"]));
            }
