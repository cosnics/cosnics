...
require_once Path :: getInstance()->getPluginPath(__NAMESPACE__) . '/pchart/class/pRadar.class.php';
...
class PolarChart extends Chart
{
    ...
    public function get_path()
    {
        ...
        $base_path = 'temp/' . md5(serialize(array('polar_chart', $reporting_data))) . '.png';
        ...
        if (! file_exists($path))
        {
            ...
            {
                $abscissa[] = $i * (360 / $number_of_categories);
                $i ++;
            }
            ...
            $chart_canvas->setFontProperties(
                array(
                    'FontName' => Path :: getInstance()->getPluginPath(__NAMESPACE__) . '/pchart/fonts/Verdana.ttf', 
                    'FontSize' => 8, 
                    'R' => 0, 
                    'G' => 0, 
                    'B' => 0));
            ...
            $options = array(
                'BackgroundGradient' => array(
                    ...
                    'EndAlpha' => 50), 
                'FontSize' => 6);
            $polar_chart->drawPolar($chart_canvas, $chart_data, $options);
