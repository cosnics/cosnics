...
class ReportingComponent extends Manager implements PreviewSupport
{
    ...
    public function run()
    {
        ...
        {
            $this->redirect(
                Translation::get('NoReportingPreview'), true, array(self::PARAM_ACTION => self::ACTION_DISPLAY)
            );
        }

        return $this->getApplicationFactory()->getApplication(
            $this->get_preview_context(), new ApplicationConfiguration($this->getRequest(), $this->get_user(), $this)
        )->run();
    }
