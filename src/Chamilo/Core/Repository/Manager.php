...
abstract class Manager extends Application
{
    ...
    const ACTION_DELETE_SHARED_CONTENT_OBJECTS = 'shared_content_objects_deleter';
    ...
    const ACTION_MOVE_SHARED_CONTENT_OBJECTS = 'shared_content_objects_mover';
    ...
    const ACTION_HTML_EDITOR_FILE = 'html_editor_file';
    const ACTION_REPOSITORY_VIEWER = 'repository_viewer';
    const ACTION_USER_VIEW = 'user_view';
    const ACTION_PREVIEW = 'previewer';
    const ACTION_PUBLICATION = 'publication';
    const ACTION_LINK_CONTENT_OBJECT_PROPERTY_METADATA = 'property_metadata_linker';
    const ACTION_LINK_CONTENT_OBJECT_METADATA_ELEMENT = 'metadata_element_linker';
    const ACTION_LINK_CONTENT_OBJECT_ALTERNATIVE = 'alternative_linker';
    const ACTION_BATCH_EDIT_CONTENT_OBJECT_METADATA = 'metadata_batch_editor';
