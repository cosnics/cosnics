...
use Chamilo\Core\Repository\Component\DocumentDownloaderComponent;
    ...
    public static function get_document_downloader_url($documentId, $securityCode = null)
    {
        ...
        $redirect = new Redirect(
            array(
                ...
                DocumentDownloaderComponent::PARAM_REDIRECTED_TO_DOWNLOAD_HOST => 1,
        ...
        {
            $downloaderUrl = $redirect->getUrl();
        }
        else
        {
            $downloaderUrl = $redirect->addParametersToUrl($fileDownloadHost);
        }
