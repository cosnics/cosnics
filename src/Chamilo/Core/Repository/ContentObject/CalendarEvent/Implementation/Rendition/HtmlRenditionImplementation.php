<?php
namespace Chamilo\Core\Repository\ContentObject\CalendarEvent\Implementation\Rendition;

use Chamilo\Core\Repository\ContentObject\CalendarEvent\Implementation\RenditionImplementation;
