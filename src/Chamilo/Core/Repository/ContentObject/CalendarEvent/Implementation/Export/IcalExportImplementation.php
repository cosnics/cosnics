...
class IcalExportImplementation extends ExportImplementation
{
    ...
    public static function rrule(CalendarEvent $content_object)
    {
        ...
        switch ($frequency)
        {
            case CalendarEvent :: FREQ_DAILY :
                $rrule['FREQ'] = 'DAILY';
                break;
            case CalendarEvent :: FREQ_WEEKLY :
                $rrule['FREQ'] = 'WEEKLY';
                
                break;
            case CalendarEvent :: FREQ_MONTHLY :
                $rrule['FREQ'] = 'MONTHLY';
                break;
            case CalendarEvent :: FREQ_YEARLY :
                $rrule['FREQ'] = 'YEARLY';
                break;
            case CalendarEvent :: FREQ_BIWEEK :
                $rrule['FREQ'] = 'WEEKLY';
                $rrule['INTERVAL'] = '2';
                break;
            case CalendarEvent :: FREQ_WEEK_DAYS :
                $rrule['FREQ'] = 'DAILY';
                $rrule['BYDAY'] = array(
                    array('DAY' => 'MO'), 
                    array('DAY' => 'TU'), 
