...
class CalendarEventForm extends ContentObjectForm
{
    ...
    public function add_calendar_form()
    {
        ...
        // $this->add_timewindow(CalendarEvent :: PROPERTY_START_DATE, CalendarEvent :: PROPERTY_END_DATE, Translation
        // :: get('StartTimeWindow'), Translation :: get('EndTimeWindow'));
        $start_date = array();
        ...
        $this->addElement(
            ...
            ResourceManager :: get_instance()->get_resource_html(
                Path :: getInstance()->namespaceToFullPath('Chamilo\Core\Repository\ContentObject\CalendarEvent\\', true) .
                     'Resources/Javascript/HtmlEditor/Dates.js'));
    }
