CKEDITOR.dialog
	.add(
		...
		function(editor) {
		    ...
		    var btnLockSizesId = numbering('btnLockSizes'), btnResetSizeId = numbering('btnResetSize');
		    ...
		    return {
			title : 'CalendarEvent Properties',
			minWidth : 400,
			minHeight : 200,
			onOk : function(evt) {
			    ...
			    var newFakeImage = editor.createChamiloFakeElement(resourceElement,
				    'cke_chamilo_calendar_event', 'chamilo');
			    // newFakeImage.setAttribute('alt',
			    // this.getValueOf('info', 'txtAlt'));
			    // newFakeImage.setAttribute('title',
			    // this.getValueOf('info', 'txtAlt'));
			...
			contents : [ {
			    ...
			    elements : [
					...
					children : [ {
					    ...
					    id : 'htmlPreview',
					    style : 'width:95%;',
					    html : '<div style="white-space: normal;border: 2px ridge black;overflow: scroll;height: 160px;padding: 2px;background-color: white;" id="'
						    + previewImageId + '"></div>'
					} ]
				    } ]
			} ]
