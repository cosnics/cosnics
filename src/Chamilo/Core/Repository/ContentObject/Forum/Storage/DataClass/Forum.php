...
class Forum extends ContentObject implements ComplexContentObjectSupport
{
    ...
    public function add_last_post($last_post)
    {
        ...
        {
            $lo = \Chamilo\Core\Repository\Storage\DataManager :: retrieve_content_object($item->get_parent());
    ...
    public function delete_complex_wrapper($object_id, $link_ids)
    {
        ...
        {
            $item = \Chamilo\Core\Repository\Storage\DataManager :: retrieve_complex_content_object_item($link_id);
            $object = \Chamilo\Core\Repository\Storage\DataManager :: retrieve_content_object($item->get_ref());
