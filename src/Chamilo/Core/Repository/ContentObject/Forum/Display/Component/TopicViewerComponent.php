 ...
 */
class TopicViewerComponent extends Manager implements BreadcrumbLessComponentInterface
{
    ...
    public function renderPager()
    {
        try
        {
            ...
            return $pagerRenderer->renderPaginationWithPageLimit(
                $this->get_parameters(), ForumTopic::getStorageUnitName() . '_' . 'page_nr'
            );
        }
        catch (Exception $ex)
        {
    ...
    public function renderPostActions(ForumPost $forumPost)
    {
        ...
        if (!$this->isLocked())
        {
            ...
            if (($forumPost->get_user_id() == $this->get_user_id() || $this->get_user()->isPlatformAdmin()) ||
