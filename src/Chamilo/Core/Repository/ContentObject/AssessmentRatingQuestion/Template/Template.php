<?php
namespace Chamilo\Core\Repository\ContentObject\AssessmentRatingQuestion\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\assessment_rating_question\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new AssessmentRatingQuestion();
