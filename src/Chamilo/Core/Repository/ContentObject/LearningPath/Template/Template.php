<?php
namespace Chamilo\Core\Repository\ContentObject\LearningPath\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\learning_path\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new LearningPath();
