...
abstract class TabComponent extends Manager implements DelegateComponent
{
    ...
    public function run()
    {
        ...
        else
        {
            ...
            {
                $variable =
                    $this->get_current_content_object() instanceof LearningPath ? 'DeleteFolder' : 'DeleterComponent';
            ...
            {
                $variable =
                    $this->get_current_content_object() instanceof LearningPath ? 'MoveFolder' : 'MoverComponent';
    ...
    private function render_progress_bar($percent, $step = 2)
    {
        ...
        $html[] =
            '<div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="' . $displayPercent .
