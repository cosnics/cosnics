<?php
namespace Chamilo\Core\Repository\ContentObject\LearningPathItem\Integration\Chamilo\Core\Metadata\PropertyProvider;

use Chamilo\Core\Repository\ContentObject\LearningPathItem\Storage\DataClass\LearningPathItem;

/**
 *
 * @package Chamilo\Core\Repository\ContentObject\LearningPathItem\Integration\Chamilo\Core\Metadata\PropertyProvider
...
class ContentObjectPropertyProvider extends \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\PropertyProvider\ContentObjectPropertyProvider
{
    ...
    {
        return LearningPathItem::class_name();
    }
}