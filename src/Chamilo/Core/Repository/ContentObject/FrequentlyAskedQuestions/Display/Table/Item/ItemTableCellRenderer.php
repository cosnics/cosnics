<?php
namespace Chamilo\Core\Repository\ContentObject\FrequentlyAskedQuestions\Display\Table\Item;
...
class ItemTableCellRenderer extends DataClassTableCellRenderer implements TableCellRendererActionsColumnSupport
{
    ...
    public function get_actions($node)
    {
        ...
        {
            $variable = $node->get_content_object() instanceof FrequentlyAskedQuestions ? 'RightsFolder' : 'RightsComponent';
