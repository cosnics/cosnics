...
$(function() {
    function addNumericOption(ev, ui) {
        ...
        fieldTolerance = '<input class="input_numeric" type="text" value="1" name="tolerance[' + numberOfOptions + ']" size="2" />';
        fieldFeedback = renderHtmlEditor(editorName, parameters);
        fieldWeight = '<input class="input_numeric" type="text" value="0" name="option_weight[' + numberOfOptions + ']" size="2" />';
        ...
        string = '<tr id="option_' + numberOfOptions + '" class="' + rowClass + '"><td>' + visibleNumber + '</td><td>' + fieldAnswer + '</td><td>' + fieldTolerance + '</td><td>' + fieldFeedback + '</td><td>' + fieldWeight + '</td><td>' + fieldDelete + '</td></tr>';
    ...
    $(document).ready(function() {
        $(document).on('click', '#add_numeric_option', addNumericOption);
