$(function () {
    ...
    function addOption(ev, ui) {
        ...
        var numberOfOptions = $('#match_number_of_options').val(), newNumber = (parseInt(numberOfOptions, 10) + 1),
            name, value, fieldOption, fieldAnswer, fieldComment, fieldScore, fieldDelete, string, htmlEditorOptions,
            editorNameAnswer, editorNameComment, type;
        ...
        fieldScore =
            '<div class="option-score-field assessment_match_question_score_container form-inline" data-element="score['
            + numberOfOptions + ']">';
        ...
        fieldTolerance =
            '<div class="option-tolerance-field form-assessment-extra-container form-inline" data-element="score['
            + numberOfOptions + ']">';
