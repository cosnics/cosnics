$(function()
{
    ...
    function addOption(ev, ui)
    {
        ...
        fieldTolerance = '<div class="option-score-field form-assessment-extra-container form-inline" data-element="score['
                + numberOfOptions + ']">';
        ...
        tableRow += '<td>' + fieldAnswer + fieldFeedback + fieldScore + fieldTolerance + '</td>';
