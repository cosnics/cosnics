<?php
namespace Chamilo\Core\Repository\ContentObject\ForumTopic\Implementation\Export\Html;

use Chamilo\Core\Repository\ContentObject\ForumTopic\Implementation\Export\HtmlExportImplementation;
...
class HtmlDefaultExportImplementation extends HtmlExportImplementation
{
    ...
    private function convert_images($body)
    {
        ...
        foreach ($elements as $i => $element)
        {
            ...
            if ($type == 'document')
            {
                $obj = \Chamilo\Core\Repository\Storage\DataManager :: retrieve_content_object($id);
                if ($obj->is_image())
                {
