...
class ComplexForumTopic extends ComplexContentObjectItem
{
    ...
    public function create()
    {
        ...
        $lo = \Chamilo\Core\Repository\Storage\DataManager :: retrieve_content_object($this->get_ref());
        
        $parent = \Chamilo\Core\Repository\Storage\DataManager :: retrieve_content_object($this->get_parent());
