...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    public static function count_forum_post_attachments($forum_post_id)
    {
        ...
        return self::count(ForumPostAttachment::class, new DataClassCountParameters(condition: $condition));
    }
    ...
    public static function count_forum_topic_posts($forum_topic_id)
    {
        ...
        return self::count(ForumPost::class, new DataClassCountParameters(condition: $condition));
    }
     ...
     * @param $type int
     *
     * @return bool returns true when successive delete
     */
     ...
     *
     * @return \Doctrine\Common\Collections\ArrayCollection Returns a result set of posts.
     */
        ...
        $join = new Join(
            ForumPost::class, new EqualityCondition(
                new PropertyConditionVariable(
                    ForumPostAttachment::class, ForumPostAttachment::PROPERTY_FORUM_POST_ID
    ...
    public static function retrieve_attached_object($forum_post_id, $attachment_id)
    {
        ...
        return self::retrieve(ForumPostAttachment::class, new RetrieveParameters(condition: $condition));
    }

    public static function retrieve_attached_object_from_forum_post(
        $forum_post_id, $offset = null, $max_objects = null, $order_by = null
    )
    {
        $condition = new EqualityCondition(
            new PropertyConditionVariable(ForumPostAttachment::class, ForumPostAttachment::PROPERTY_FORUM_POST_ID),
        ...
        $joins->add(
            new Join(
                ForumPostAttachment::class, new EqualityCondition(
                    new PropertyConditionVariable(ContentObject::class, ContentObject::PROPERTY_ID),
                    new PropertyConditionVariable(
                        ForumPostAttachment::class, ForumPostAttachment::PROPERTY_ATTACHMENT_ID
                    )
                )
            )
        );
    ...
    public static function retrieve_attached_objects($forum_post_id)
    {
        ...
        return self::retrieves(ForumPostAttachment::class, new RetrievesParameters(condition: $condition));
    }
     ...
     * @return DataClass
     */
    protected static function retrieve_forum_post_by_creation_date_order_from_forum_topic(
        $forum_topic_id, $creation_date_order
    )
    {
        $condition = new EqualityCondition(
            new PropertyConditionVariable(ForumPost::class, ForumPost::PROPERTY_FORUM_TOPIC_ID),
        ...
        $orderBy = OrderBy::generate(
            ForumPost::class, ForumPost::PROPERTY_CREATION_DATE, $creation_date_order
        );

        $parameters = new RetrieveParameters(condition: $condition, orderBy: $orderBy);
    ...
    public static function retrieve_forum_post_of_topic($topic_id, $post_id)
    {
        ...
        return self::retrieve(ForumPost::class, new RetrieveParameters(condition: $condition));
    }

    /*
     * This method retrieves an array of the attached content objects of a particular post. @param int $forum_post_id
     * the id of the forum post. @param int $offset @param int $max_objects @param int $order_by @return \Doctrine\Common\Collections\ArrayCollection A
    ...
    public static function retrieve_forum_posts($forum_topic_id, $condition = null)
    {
        ...
        return self::retrieves(ForumPost::class, new RetrievesParameters(condition: $condition));
    }
    ...
    public static function retrieve_subscribe($forum_topic_id, $user_id)
    {
        ...
        $conditions[] = new EqualityCondition(
            new PropertyConditionVariable(
                ForumTopicSubscribe::class, ForumTopicSubscribe::PROPERTY_FORUM_TOPIC_ID
            ), new StaticConditionVariable($forum_topic_id)
        );
        ...
        return self::retrieve(ForumTopicSubscribe::class, new RetrieveParameters(condition: $condition));
    }
    ...
    public static function retrieve_subscribed_forum_topic_users($forum_topic_id)
    {
        ...
        foreach ($subscribeds as $subscribe)
        {
            $user = DataManager::retrieve_by_id(
                User::class, (string) $subscribe->get_user_id()
            );
    ...
    public static function retrieve_subscribes($forum_topic_id)
    {
        ...
        return self::retrieves(ForumTopicSubscribe::class, new RetrievesParameters(condition: $condition));
    }
}
