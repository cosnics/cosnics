    ...
    public function run()
    {
        ...
        if (!\Chamilo\Core\Repository\Viewer\Manager::is_ready_to_be_published())
        {
            ...
            $component->set_parameter(
                Manager::PARAM_COMPLEX_CONTENT_OBJECT_ITEM_ID, $this->get_parent()->get_complex_content_object_item_id()
            );
        ...
        else
        {
            ...
            $this->redirectWithMessage(
                Translation::get(
                    'ObjectAdded', ['OBJECT' => Translation::get('ContentObject')], StringUtilities::LIBRARIES
                ), false, [
