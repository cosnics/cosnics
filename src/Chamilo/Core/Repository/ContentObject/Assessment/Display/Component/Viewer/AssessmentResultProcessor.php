...
class AssessmentResultProcessor
{
    ...
    public function finish_assessment()
    {
        ...
        foreach ($complex_questions as $complex_question)
        {
            ...
            $display = AssessmentQuestionResultDisplay::factory(
                $this->get_assessment_viewer(), $complex_question, $question_number, $answer, $score, $hints
            );
    ...
    {
        $form =
            new AssessmentResultViewerForm($this, FormValidator::FORM_METHOD_POST, $this->assessment_viewer->get_url());
    ...
    public function save_answers($results_page_number)
    {
        ...
        foreach ($questions_cloi as $question_cloi)
        {
            ...
            $score_calculator = ScoreCalculator::factory(
                $question_cloi->get_ref_object(), $answers, $question_cloi->get_weight()
            );
            ...
            {
                $display = AssessmentQuestionResultDisplay::factory(
                    $this->get_assessment_viewer(), $question_cloi, $question_number, $answers, $score, $hints
                );
            ...
            $this->assessment_viewer->save_assessment_answer(
                $question_cloi->get_id(), serialize($answers), $score,
