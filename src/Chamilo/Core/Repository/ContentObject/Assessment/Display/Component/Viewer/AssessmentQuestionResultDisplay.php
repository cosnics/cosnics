...
abstract class AssessmentQuestionResultDisplay
{
    ...
    public function header()
    {
        ...
        $html[] = '<h3 class="panel-title pull-left">' . $this->question_nr . '. ' . $this->question->get_title() .
             '</h3>';
    ...
    public static function factory(Application $viewerApplication, $complex_content_object_question, $question_nr,
        $answers, $score, $hints)
    {
        $class = $complex_content_object_question->get_ref_object()->package() . '\Integration\\' . Assessment::package() .
