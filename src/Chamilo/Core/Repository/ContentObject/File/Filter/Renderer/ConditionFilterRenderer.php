        ...
        if ($filter_data->has_filter_property(FilterData::FILTER_FILESIZE))
        {
            ...
            if ($compare == ComparisonCondition::EQUAL)
            {
                ...
                $equality_conditions[] = new ComparisonCondition(
                    ...
                    ComparisonCondition::GREATER_THAN_OR_EQUAL, new StaticConditionVariable($filesize_bytes * 0.9)
                );
                $equality_conditions[] = new ComparisonCondition(
                    new PropertyConditionVariable(File::class, File::PROPERTY_FILESIZE),
                    ComparisonCondition::LESS_THAN_OR_EQUAL, new StaticConditionVariable($filesize_bytes * 1.1)
                );
            ...
            else
            {
                $conditions[] = new ComparisonCondition(
                    new PropertyConditionVariable(File::class, File::PROPERTY_FILESIZE), $compare,
        ...
        elseif ($filter_data->has_filter_property(FilterData::FILTER_EXTENSION_TYPE))
        {
            ...
            foreach ($extensions as $extension)
            {
                $extension_conditions[] = new EndsWithCondition(
                    new PropertyConditionVariable(File::class, File::PROPERTY_FILENAME), $extension
                );
            }
