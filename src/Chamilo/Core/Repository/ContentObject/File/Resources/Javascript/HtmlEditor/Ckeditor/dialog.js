                ...
                function(editor)
                {
                    ...
                    var switchLockRatio = function(dialog, value)
                    {
                        ...
                        if (value == 'check')
                        {
                            ...
                            {
                                var width = dialog.getValueOf('info', 'width'), height = dialog.getValueOf('info',
                                        'height'), originalRatio = oImageOriginal.$.width * 1000
                                        / oImageOriginal.$.height, thisRatio = width * 1000 / height;
                        ...
                        if (CKEDITOR.env.hc)
                        {
                            ...
                            icon.setHtml(dialog.lockRatio ? CKEDITOR.env.ie ? '\u25A0' : '\u25A3'
                                    : CKEDITOR.env.ie ? '\u25A1' : '\u25A2');
                        }
                    ...
                    var resetSize = function(dialog)
                    {
                        ...
                        if (oImageOriginal.getCustomData('isReady') == 'true')
                        {
                            var widthField = dialog.getContentElement('info', 'width'), heightField = dialog
                    ...
                    var setupDimension = function(element)
                    {
                        ...
                        var dialog = this.getDialog(), value = '', dimension = this.id == 'width' ? 'width' : 'height', size = element
                    ...
                    return {
                        ...
                        onOk : function(evt)
                        {
                            ...
                            var newFakeImage = editor.createChamiloFakeElement(resourceElement, 'cke_chamilo_file',
                                    'chamilo');
                        ...
                        onShow : function()
                        {
                            ...
                            if (fakeElement && fakeElement.data('cke-real-element-type')
                                    && fakeElement.data('cke-real-element-type') == 'chamilo')
                            {
                                        ...
                                        children : [
                                                {
                                                    ...
                                                    onChange : function()
                                                    {
                                                        ...
                                                        {
                                                            blockUpdatePreview = true;
                                                            var img = $('img', $(currentRendition)).attr("src");
                                                            
                                                            var ajaxUri = getPath('WEB_PATH') + 'index.php';
                                                            var parameters = {
                                                                'application' : 'Chamilo\\Core\\Repository\\Ajax',
                                                                'go' : 'image_properties',
                                                                'content_object' : sourceDialog.getValueOf('info',
                                                                        'source')
                                                            };
                                                            ...
                                                            var response = $.ajax({
                                                                ...
                                                                async : false
                                                                    ...
                                                                    function(json)
                                                                    {
                                                                        sourceDialog.setValueOf('info', 'width',
                                                                                json.properties.width);
                                                                        sourceDialog.setValueOf('info', 'height',
                                                                                json.properties.height);
                                                                        
                                                                        switchLockRatio(sourceDialog, true);
                                                                        blockUpdatePreview = false;
                                                                    }).error(function(json)
                                                            {
                                                                sourceDialog.setValueOf('info', 'width', '420');
                                                                sourceDialog.setValueOf('info', 'height', '340');
                                                                blockUpdatePreview = false;
                                                            });
                                                        }
                                                                                ...
                                                                                if (ratioButton)
                                                                                {
                                                                                    ratioButton
                                                                                            .on(
                                                                                                    ...
                                                                                                    function(evt)
                                                                                                    {
                                                                                                        var locked = switchLockRatio(this), oImageOriginal = this.originalElement, width = this
                                                                                                                .getValueOf(
                                                                                                                        'info',
                                                                                                                        'width');
                                                                ...
                                                                children : [
                                                                        {
                                                                            ...
                                                                            commit : function(element)
                                                                            {
                                                                                element.setAttribute('border', this
                                                                                        .getValue());
                                                                            }
                                                                        },
                                                                        {
                                                                            ...
                                                                            setup : function(element)
                                                                            {
                                                                                ...
                                                                                this
                                                                                        .setValue(element
                                                                                                .getAttribute('margin-horizontal'));
                                                                                blockUpdatePreview = false;
                                                                            },
                                                                            commit : function(element)
                                                                            {
                                                                                element.setAttribute(
                                                                                        'margin-horizontal', this
                                                                                                .getValue());
                                                                            }
                                                                        },
                                                                        {
                                                                            ...
                                                                            setup : function(element)
                                                                            {
                                                                                ...
                                                                                this
                                                                                        .setValue(element
                                                                                                .getAttribute('margin-vertical'));
                                                                                blockUpdatePreview = false;
                                                                            },
                                                                            commit : function(element)
                                                                            {
                                                                                element.setAttribute('margin-vertical',
                                                                                        this.getValue());
                                                                            }
                                                                        },
                                                                        {
                                                                            ...
                                                                            commit : function(element)
                                                                            {
                                                                                element.setAttribute('align', this
                                                                                        .getValue());
                                                                            }
                                                                        } ]
                                                            } ]
                                                },
                                                {
                                                    ...
                                                    children : [ {
                                                        ...
                                                        html : '<div>'
                                                                ...
                                                                + '<br>'
                                                                + '<div style="white-space: normal;border: 2px ridge black;overflow: scroll;height: 160px;width: 230px;padding: 2px;background-color: white;" id="'
                                                                + previewImageId + '"></div></div>'
                                                    } ]
                                                } ]
                                    } ]
                        } ]
