<?php
namespace Chamilo\Core\Repository\ContentObject\File\Implementation\Import;

use Chamilo\Core\Repository\Common\Import\ContentObjectImport;
use Chamilo\Core\Repository\ContentObject\File\Implementation\ImportImplementation;
