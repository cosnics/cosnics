...
class HtmlInlineMp3RenditionImplementation extends HtmlInlineRenditionImplementation
{
    ...
    public function render($parameters)
    {
        ...
        $html[] = '<object type="application/x-shockwave-flash" data="' .
             Path :: getInstance()->getPluginPath(null, true) .
             'mp3_player/player_mp3_maxi.swf" width="300" height="20">';
        $html[] = '<param name="movie" value="' . Path :: getInstance()->getPluginPath(null, true) .
             'mp3_player/player_mp3_maxi.swf" />';
