...
class RepositoryTableColumnModel extends \Chamilo\Core\Repository\Table\ContentObject\Table\RepositoryTableColumnModel
{
    ...
    {
        $this->add_column(new DataClassPropertyTableColumn(File::class, File::PROPERTY_EXTENSION));
        $this->add_column(new DataClassPropertyTableColumn(File::class, File::PROPERTY_FILESIZE));
    }
}
