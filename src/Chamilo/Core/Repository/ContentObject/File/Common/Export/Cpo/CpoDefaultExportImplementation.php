<?php
namespace Chamilo\Core\Repository\ContentObject\File\Common\Export\Cpo;

use Chamilo\Core\Repository\Common\Export\ContentObjectExport;
use Chamilo\Core\Repository\ContentObject\File\Common\Export\CpoExportImplementation;
