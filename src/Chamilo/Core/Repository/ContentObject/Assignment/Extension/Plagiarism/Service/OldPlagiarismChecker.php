...
class OldPlagiarismChecker
{
    ...
    )
    {
        ...
        $submissionId = $this->submissionService->uploadFile(
    ...
    )
    {
        ...
        $progressStatus = $this->submissionService->getUploadStatus($entryPlagiarismResult->getExternalId());
    ...
    )
    {
        ...
        $progressStatus = $this->submissionService->getSimilarityReportStatus($entryPlagiarismResult->getExternalId());
        if (!$progressStatus->isInProgress())
        {
            $entryPlagiarismResult->copyFromSubmissionStatus($progressStatus);
            $entryPlagiarismResultServiceBridge->updateEntryPlagiarismResult($entryPlagiarismResult);
    ...
    )
    {
        ...
        $this->submissionService->generateSimilarityReport(
    ...
    )
    {
        ...
        $uploadStatus = $this->submissionService->getUploadStatus($entryPlagiarismResult->getExternalId());
    ...
    public function generateSimilarityReport($externalId)
    {
        ...
        $this->submissionService->generateSimilarityReport($externalId, $similarityReportSettings);
    }
    ...
    public function canCheckForPlagiarism(Entry $entry)
    {
        ...
        return $this->submissionService->canUploadFile($contentObject->get_full_path(), $contentObject->get_filename());
    }
