...
class Embedder extends ContentObjectEmbedder
{
    ...
    public function run()
    {
        ...
        $assignmentDataProvider = new AssignmentDataProvider(
            $this->get_application()->getTranslator(), new LearningPathAssignmentService(
        ...
        $assignmentDataProvider->setContentObjectPublication(
            $this->get_application()->get_application()->get_publication()
        );
