    ...
    public function render_cell($column, $entry)
    {
        ...
        switch ($column->get_name())
        {
            case ContentObject::PROPERTY_TITLE :
                ...
                $title = StringUtilities::getInstance()->createString($title)->safeTruncate(50, ' &hellip;')->__toString();
            ...
            case ContentObject::PROPERTY_DESCRIPTION :
                ...
                return StringUtilities::getInstance()->createString($description)->safeTruncate(100, ' &hellip;')->__toString();
                break;
