...
abstract class AssignmentRepository
{
    ...
    public function countContentObjectsUsedAsEntryByContentObjectIds($contentObjectIds = [])
    {
        ...
        return $this->dataClassRepository->count(
            $this->getEntryClassName(), new StorageParameters(condition: $condition)
        );
    }
    ...
    )
    {
        ...
        $parameters = new StorageParameters(condition: $condition, retrieveProperties: $property);
    ...
    public function countEntryAttachmentsByAttachmentIds($attachmentIds = [])
    {
        ...
        return $this->dataClassRepository->count(
            $this->getEntryAttachmentClassName(), new StorageParameters(condition: $condition)
        );
    }
    ...
    public function countEntryAttachmentsByUserId($userId)
    {
        ...
        return $this->dataClassRepository->count(
            $this->getEntryAttachmentClassName(), new StorageParameters(condition: $condition, joins: $joins)
        );
    }
    ...
    public function findEntryAttachmentsByUserId($userId)
    {
        ...
        return $this->dataClassRepository->retrieves(
            $this->getEntryAttachmentClassName(), new StorageParameters(
    ...
    )
    {
        ...
        return $this->dataClassRepository->records(
            $this->getEntryClassName(), new StorageParameters(
    ...
    protected function findLastEntryForEntity($entityType, $entityIdentifier, Condition $condition = null)
    {
        ...
        $retrieveParameters = new StorageParameters(
    ...
    public function retrieveNoteByEntry(Entry $entry)
    {
        ...
        $note = $this->dataClassRepository->retrieve(
            $this->getNoteClassName(), new StorageParameters(condition: $condition)
        );
    ...
    public function retrieveScoreByEntry(Entry $entry)
    {
        ...
        $score = $this->dataClassRepository->retrieve(
            $this->getScoreClassName(), new StorageParameters(condition: $condition)
        );
