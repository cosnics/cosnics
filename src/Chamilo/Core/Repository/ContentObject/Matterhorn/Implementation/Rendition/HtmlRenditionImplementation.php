<?php
namespace Chamilo\Core\Repository\ContentObject\Matterhorn\Implementation\Rendition;

use Chamilo\Core\Repository\ContentObject\Matterhorn\Implementation\RenditionImplementation;
