...
class Office365VideoForm extends ContentObjectForm
{
    protected function build_creation_form()
    {
        ...
        $external_repositories = \Chamilo\Core\Repository\Instance\Manager :: get_links(array(Office365Video :: package()), true);
    ...
    public function create_content_object()
    {
        ...
        if ($success)
        {
            ...
            $externalRepositoryObjectId = (string)$this->exportValue(SynchronizationData :: PROPERTY_EXTERNAL_OBJECT_ID);
