<?php
namespace Chamilo\Core\Repository\ContentObject\ExternalCalendar\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\external_calendar\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new ExternalCalendar();
