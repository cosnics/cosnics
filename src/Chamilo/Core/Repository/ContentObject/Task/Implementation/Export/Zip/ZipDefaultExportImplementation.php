<?php
namespace Chamilo\Core\Repository\ContentObject\Task\Implementation\Export\Zip;
...
use Chamilo\Core\Repository\ContentObject\Task\Implementation\Export\ZipExportImplementation;
