<?php
namespace Chamilo\Core\Repository\ContentObject\OrderingQuestion\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\ordering_question\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new OrderingQuestion();
