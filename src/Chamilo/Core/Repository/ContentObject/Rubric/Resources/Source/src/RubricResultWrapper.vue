<template>
    <div id="rubric-result-wrapper" class="container-fluid">
        <rubric-result :api-config="config" :rubric-data="rubricData" :version="version" :rubric-results="rubricResults"></rubric-result>
    </div>
</template>
