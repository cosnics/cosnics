...
class DeleterComponent extends Manager
{
    ...
    public function run()
    {
        ...
        foreach ($available_nodes as $available_node)
        {
            ...
            if (! ($complex_content_object_item instanceof ComplexSurvey ||
                 $complex_content_object_item instanceof ComplexPage))
            {
                $page_id = $complex_content_object_item->get_parent();
                ...
                while ($configuration = $configurations->next_result())
                {
                    ...
                    else
                    {
                        ...
                        $newToVisibleQuestionIds = array_diff(
                            $toVisibleQuestionIds, 
                            array($complex_content_object_item_id));
