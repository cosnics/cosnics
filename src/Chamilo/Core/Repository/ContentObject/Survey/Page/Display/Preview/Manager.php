...
abstract class Manager extends \Chamilo\Core\Repository\Display\Preview
{
    ...
    {
        $this->set_parameter(\Chamilo\Core\Repository\ContentObject\Survey\Page\Display\Manager :: PARAM_PAGE_ITEM_ID, Request :: get(\Chamilo\Core\Repository\ContentObject\Survey\Page\Display\Manager :: PARAM_PAGE_ITEM_ID));
        $this->set_parameter(
