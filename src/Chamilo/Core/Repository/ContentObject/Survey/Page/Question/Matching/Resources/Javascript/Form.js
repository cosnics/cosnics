...
$(function ()
{
	...
	function removeOption(ev, ui)
	{
		...
		var tableBody = $(this).parent().parent().parent(),
			...
			row = 0, rows, ajaxUri = getPath('WEB_PATH') + 'index.php' ;
		...
		doAjaxPost(
				ajaxUri, {
					"application" : "Chamilo\\Core\\Repository\\ContentObject\\Survey\\Page\\Question\\Matching\\Ajax",
					"go" : "remove_option",
					"option_id" : id
				});
