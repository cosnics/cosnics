<?php
namespace Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Order\Implementation\Import;

use Chamilo\Core\Repository\Common\Import\ContentObjectImport;
use Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Order\Implementation\Export\CpoExportImplementation;
use Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Order\Implementation\ImportImplementation;
    ...
    function import()
    {
        ...
        foreach ($dom_xpath->query(CpoExportImplementation :: OPTION_NODE, $option_node_list) as $option_node)
        {
            $this->get_controller()->set_cache_id(
                OrderOption :: get_table_name(), 
                OrderOption :: PROPERTY_ID, 
