<?php
namespace Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Gender\Integration\Chamilo\Core\Reporting\Preview\Component;

use Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Gender\Integration\Chamilo\Core\Reporting\Interfaces\TemplateSupport;
use Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Gender\Integration\Chamilo\Core\Reporting\Preview\Manager;
...
class TableComponent extends Manager implements TemplateSupport
{
    ...
    /*
     * (non-PHPdoc) @see
     * \repository\content_object\survey_gender_question\integration\reporting\TemplateSupport::get_answers()
     */
    ...
    /*
     * (non-PHPdoc) @see
     * \repository\content_object\survey_gender_question\integration\reporting\TemplateSupport::get_question()
     */
