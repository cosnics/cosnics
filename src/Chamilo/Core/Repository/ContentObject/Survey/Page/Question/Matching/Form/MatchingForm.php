...
class MatchingForm extends ContentObjectForm
{
    ...
    function setDefaults($defaults = array ())
    {
        ...
        $defaults[Matching :: PROPERTY_QUESTION] = $defaults[Matching :: PROPERTY_QUESTION] ==
             null ? $object->get_question() : $defaults[Matching :: PROPERTY_QUESTION];
        ...
        if ($object->get_number_of_options() != 0)
            ...
            if ($object->get_number_of_options() != 0)
            {
                ...
                {
                    $defaults[MatchingOption :: PROPERTY_VALUE . '[' . ($option->get_display_order() - 1) .
                         ']'] = $option->get_value();
                }
                ...
                {
                    $defaults[MatchingMatch :: PROPERTY_VALUE . '[' . ($match->get_display_order() - 1) .
                         ']'] = $match->get_value();
                }
            }
            else
