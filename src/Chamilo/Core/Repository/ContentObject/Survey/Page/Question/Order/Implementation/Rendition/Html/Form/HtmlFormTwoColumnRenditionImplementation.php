...
class HtmlFormTwoColumnRenditionImplementation extends HtmlFormRenditionImplementation
{
    ...
    function render(FormValidator $formvalidator, ComplexOrderForm $complex_content_object_item, 
        $answer = null)
    {
        ...
        $formvalidator->addElement(
            ...
            ResourceManager :: get_instance()->get_resource_html(
                Path :: getInstance()->namespaceToFullPath(__NAMESPACE__, true) . 'resources/javascript/two_column.js'));
    }
