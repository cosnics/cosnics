<?php
namespace Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Matching\Common\Import;

use Chamilo\Core\Repository\Common\Import\ContentObjectImport;
use Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Matching\Common\Export\CpoExportImplementation;
use Chamilo\Core\Repository\ContentObject\Survey\Page\Question\Matching\Common\ImportImplementation;
...
class CpoImportImplementation extends ImportImplementation
{
    ...
    function import()
    {
        ...
        $export_node = $dom_xpath->query(CpoExportImplementation::SURVEY_MATCHING_QUESTION_EXPORT, $content_object_node)->item(
            0);
