...
class RatingForm extends ContentObjectForm
{
    ...
    */
    ...
    function setDefaults($defaults = array ())
    {
        ...
        $defaults[Rating :: PROPERTY_QUESTION] = $defaults[Rating :: PROPERTY_QUESTION] ==
             null ? $object->get_question() : $defaults[Rating :: PROPERTY_QUESTION];
