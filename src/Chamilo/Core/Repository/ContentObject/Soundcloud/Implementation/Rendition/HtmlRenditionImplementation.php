<?php
namespace Chamilo\Core\Repository\ContentObject\Soundcloud\Implementation\Rendition;

use Chamilo\Core\Repository\ContentObject\Soundcloud\Implementation\RenditionImplementation;
