...
namespace Chamilo\Core\Repository\ContentObject\GradeBook\DependencyInjection;
...
class DependencyInjectionExtension extends Extension implements IConfigurableExtension
{
    ...
    public function load(array $config, ContainerBuilder $container)
    {
        $loader = new XmlFileLoader(
            $container, new FileLocator(
                Path::getInstance()->namespaceToFullPath('Chamilo\Core\Repository\ContentObject\GradeBook') .
    ...
    {
        return 'chamilo.core.repository.content_object.gradebook';
    }
}
