 ...
 * base for a repository\content_object\peer_assessment\display.
 *
 * @author Hans De Bisschop
 */
interface PeerAssessmentDisplaySupport extends DisplaySupport
{
    // region user
    ...
    /**
     * Update the stored value of the user's progress (in percent) WARNING: this value should be updated in the
     * following cases: * every time another the user submits new scores * a user is added or removed from the same
     * group
     *
     * @param int $user_id
     * @param int $attempt_id
