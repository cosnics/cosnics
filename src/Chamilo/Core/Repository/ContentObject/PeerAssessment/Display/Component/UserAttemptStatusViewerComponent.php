...
class UserAttemptStatusViewerComponent extends Manager implements TableSupport
{
    ...
    public function render_action_bar()
    {
        ...
        $action_bar->add_tool_action(
            new ToolbarItem(
                ...
                Theme :: getInstance()->getCommonImagePath('view_list'),
                $this->get_url(array(self :: PARAM_BROWSER => self :: BROWSER_MODE_LIST))));
        $action_bar->add_tool_action(
            new ToolbarItem(
                Translation :: get('Table'),
                Theme :: getInstance()->getCommonImagePath('view_table'),
    ...
    public function get_condition()
    {
        return new EqualityCondition(
            WeblcmsPeerAssessmentAttemptTracker :: PROPERTY_PUBLICATION_ID,
            $this->publication_id);
    }
