...
class PeerAssessmentGroupForm extends FormValidator
{
    ...
    private function build_basic_form()
    {
        ...
        $this->add_html_editor(
            self::PARAM_DESCRIPTION, Translation::get('Description', null, Utilities::COMMON_LIBRARIES)
        );
        ...
        $elem = $this->addElement(
            'user_group_finder', Manager::PARAM_GROUP_USERS,
            Translation::get('SubscribeUsers', null, Utilities::COMMON_LIBRARIES), $this->viewer->get_group_feed_path(),
            $locale, $current, array('load_elements' => true)
        );
    }
