...
class AttemptBrowserComponent extends Manager
{
    ...
    public function run()
    {
        ...
        else
        {
            ...
            $html[] =
                '<div class="context_info alert alert-warning">' . Translation::get('AttemptInfoMessage') . '</div>';
    ...
    private function render_toolbar($attempt)
    {
        ...
        $toolbar->add_item(
            new ToolbarItem(
                ...
                array(
                    self::PARAM_ACTION => self::ACTION_DELETE_ATTEMPT, self::PARAM_ATTEMPT => $attempt->get_id()
                )
