<?php
namespace Chamilo\Core\Repository\ContentObject\SystemAnnouncement\Integration\Chamilo\Core\Metadata\PropertyProvider;

use Chamilo\Core\Repository\ContentObject\SystemAnnouncement\Storage\DataClass\SystemAnnouncement;

/**
 *
 * @package Chamilo\Core\Repository\ContentObject\SystemAnnouncement\Integration\Chamilo\Core\Metadata\PropertyProvider
...
class ContentObjectPropertyProvider extends \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\PropertyProvider\ContentObjectPropertyProvider
{
    ...
    {
        return SystemAnnouncement :: class_name();
    }
}