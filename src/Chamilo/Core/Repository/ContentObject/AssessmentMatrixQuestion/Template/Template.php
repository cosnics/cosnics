<?php
namespace Chamilo\Core\Repository\ContentObject\AssessmentMatrixQuestion\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\assessment_matrix_question\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new AssessmentMatrixQuestion();
