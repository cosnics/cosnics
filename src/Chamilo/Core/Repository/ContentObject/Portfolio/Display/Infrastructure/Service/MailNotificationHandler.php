...
class MailNotificationHandler extends \Chamilo\Core\Repository\Feedback\Infrastructure\Service\MailNotificationHandler
{
    ...
    public function __construct(
        MailerInterface $mailer, User $portfolioUser, ContentObject $contentObject, $feedbackURL
    )
    {
    ...
    protected function getTranslation(
        $variable, $parameters, $context = 'Chamilo\Core\Repository\ContentObject\Portfolio\Display'
    )
    {
