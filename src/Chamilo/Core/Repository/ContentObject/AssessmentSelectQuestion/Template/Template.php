<?php
namespace Chamilo\Core\Repository\ContentObject\AssessmentSelectQuestion\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\assessment_select_question\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new AssessmentSelectQuestion();
