$(function()
{
    ...
    var ajaxContext = 'Chamilo\\Core\\Repository\\ContentObject\\AssessmentSelectQuestion\\Ajax';
    var ajaxUri = getPath('WEB_PATH') + 'index.php';
    var translationContext = 'Chamilo\\Core\\Repository\\ContentObject\\AssessmentSelectQuestion';
    ...
    function convertType(ev, ui)
    {
        ...
        var answerType = $('#select_answer_type').val(), newLabel, newType, counter = 0;
        
        if (answerType == 'radio')
        {
            newType = 'checkbox';
            newLabel = getTranslation('SwitchToMultipleSelect', null, translationContext);
        }
        else
        {
            newType = 'radio';
            newLabel = getTranslation('SwitchToSingleSelect', null, translationContext)
        }
    ...
    function addOption(ev, ui)
    {
        ...
        var numberOfOptions = $('#select_number_of_options').val(), newNumber = (parseInt(numberOfOptions, 10) + 1), mcAnswerType = $(
                '#select_answer_type').val(), name, value, fieldOption, fieldAnswer, fieldComment, fieldScore, fieldDelete, string, htmlEditorOptions, editorNameAnswer, editorNameComment, type;
        ...
        fieldAnswer = '<input class="form-control" name="value[' + numberOfOptions + ']" type="text">';
