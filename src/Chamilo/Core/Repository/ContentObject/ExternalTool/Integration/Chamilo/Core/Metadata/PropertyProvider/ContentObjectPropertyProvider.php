<?php
namespace Chamilo\Core\Repository\ContentObject\ExternalTool\Integration\Chamilo\Core\Metadata\PropertyProvider;

use Chamilo\Core\Repository\ContentObject\ExternalTool\Storage\DataClass\ExternalTool;

/**
 *
 * @package Chamilo\Core\Repository\ContentObject\ExternalTool\Integration\Chamilo\Core\Metadata\PropertyProvider
...
class ContentObjectPropertyProvider extends \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\PropertyProvider\ContentObjectPropertyProvider
{
    ...
    {
        return ExternalTool::class_name();
    }
}