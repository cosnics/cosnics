<?php
namespace Chamilo\Core\Repository\ContentObject\ExternalTool\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     *
     * @return \Chamilo\Core\Repository\ContentObject\ExternalTool\Template\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new ExternalTool();
