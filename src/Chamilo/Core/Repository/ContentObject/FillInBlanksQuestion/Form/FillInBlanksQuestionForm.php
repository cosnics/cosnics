...
class FillInBlanksQuestionForm extends ContentObjectForm
{
    ...
    private function build_fill_in_the_blanks_form()
    {
        ...
        $this->addElement(
            'checkbox', 
            FillInBlanksQuestion :: PROPERTY_CASE_SENSITIVE, 
            Translation :: get('CaseSensitive'));
        ...
        $this->add_textfield(
            self :: FIELD_OPTION_VARIATION, 
            Translation :: get('Variation'), 
            false, 
            array("size" => "5"));
        ...
        $this->addElement(
            ...
            ResourceManager :: get_instance()->get_resource_html(
                Path :: getInstance()->getBasePath(true) .
                     'repository/content_object/fill_in_blanks_question/resources/javascript/fill_in_the_blanks.js'));
    ...
    public function setDefaults($defaults = array())
    {
        if (! $this->isSubmitted())
        {
            ...
            else
            {
                ...
                $defaults[FillInBlanksQuestion :: PROPERTY_DEFAULT_POSITIVE_SCORE] = FillInBlanksQuestion :: DEFAULT_POSITIVE_SCORE;
                $defaults[FillInBlanksQuestion :: PROPERTY_DEFAULT_NEGATIVE_SCORE] = FillInBlanksQuestion :: DEFAULT_NEGATIVE_SCORE;
