...
class Display extends QuestionDisplay
{
    ...
    public function add_question_form()
    {
        ...
        {
            $hint_table = array();
            $hint_table[] = '<table class="data_table take_assessment" id="hint_table_' . $id .
                 '" style="display:none;">';
            $hint_table[] = '<thead>';
            $hint_table[] = '<tr>';
            $hint_table[] = '<th></th>';
    ...
    public function add_text($name, $size)
    {
        ...
        return $formvalidator->createElement(
            ...
            null, 
            array(
                'class' => FillInBlanksQuestion :: TEXT_INPUT_FIELD_CSS_CLASS, 
                'size' => $size, 
                'autocomplete' => 'off'));
    }
    ...
    public function get_instruction()
    {
        ...
        if ($question->has_description())
        {
            ...
            $instruction[] = Translation :: get(
                'QuestionText', 
                null, 
                ContentObject :: get_content_object_type_namespace($this->get_question()->get_type_name()));
            $instruction[] = '</div>';
        }
        else
        {
