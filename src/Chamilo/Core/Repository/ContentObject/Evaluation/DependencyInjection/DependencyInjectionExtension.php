...
namespace Chamilo\Core\Repository\ContentObject\Evaluation\DependencyInjection;
...
class DependencyInjectionExtension extends Extension implements ExtensionInterface
{
    ...
    public function load(array $config, ContainerBuilder $container)
    {
        $loader = new XmlFileLoader(
            $container, new FileLocator(
                Path::getInstance()->namespaceToFullPath('Chamilo\Core\Repository\ContentObject\Evaluation\Display') .
    ...
    {
        return 'chamilo.core.repository.content_object.evaluation';
    }
}
