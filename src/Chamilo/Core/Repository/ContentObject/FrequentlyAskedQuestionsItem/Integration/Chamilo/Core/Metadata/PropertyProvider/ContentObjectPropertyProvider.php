<?php
namespace Chamilo\Core\Repository\ContentObject\FrequentlyAskedQuestionsItem\Integration\Chamilo\Core\Metadata\PropertyProvider;
...
class ContentObjectPropertyProvider extends \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\PropertyProvider\ContentObjectPropertyProvider
{
    ...
    {
        return FrequentlyAskedQuestionsItem::class_name();
    }
}