<?php
namespace Chamilo\Core\Repository\ContentObject\FrequentlyAskedQuestionsItem\Storage\DataClass;
 ...
 */
class FrequentlyAskedQuestionsItem extends ContentObject implements Versionable, HelperContentObjectSupport
{
    ...
    {
        if (! $this->reference_object instanceof FrequentlyAskedQuestions)
        {
