    ...
    public function run()
    {
        ...
        if (!empty($page))
        {
            ...
            $this->redirectWithMessage(
                ...
                [self::PARAM_ACTION => self::ACTION_VIEW_WIKI, 'pid' => $this->getRequest()->query->get('pid')]
            );
        }
        else
        {
            $this->redirectWithMessage(
                Translation::get('HomepageNotSelected'), true, [self::PARAM_ACTION => self::ACTION_BROWSE_WIKI]
            );
        }
    }
}
