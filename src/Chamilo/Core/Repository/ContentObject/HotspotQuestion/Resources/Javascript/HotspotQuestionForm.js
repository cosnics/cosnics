...
$(function () {
    ...
    var colours = ['#ff0000', '#f2ef00', '#00ff00', '#00ffff', '#0000ff',
            '#ff00ff', '#0080ff', '#ff0080', '#00ff80', '#ff8000', '#8000ff'], offset, currentPolygon = null,
        positions = [], skippedOptions = 0;
    ...
    function addOption(ev, ui) {
        ...
        var numberOfOptions = $('#mc_number_of_options').val(), newNumber = (parseInt(
            ...
            : 'row_odd', name = 'correct[' + numberOfOptions + ']', id = name, fieldColour, fieldCoordinates,
            fieldAnswer, fieldComment, fieldScore, fieldEdit, fieldReset, fieldDelete, string, parameters,
            editorNameAnswer, editorNameComment;
        ...
        $('#hotspot_marking .colour_box').css(
            'background-color',
    ...
    $(document).ready(
        function () {
            ...
            $(document).on('click', 'button[name*="edit"]', editPolygon);
