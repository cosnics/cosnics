<?php
namespace Chamilo\Core\Repository\ContentObject\HotspotQuestion\Integration\Chamilo\Core\Metadata\PropertyProvider;

use Chamilo\Core\Repository\ContentObject\HotspotQuestion\Storage\DataClass\HotspotQuestion;

/**
 *
 * @package Chamilo\Core\Repository\ContentObject\HotspotQuestion\Integration\Chamilo\Core\Metadata\PropertyProvider
...
class ContentObjectPropertyProvider extends \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\PropertyProvider\ContentObjectPropertyProvider
{
    ...
    {
        return HotspotQuestion :: class_name();
    }
}