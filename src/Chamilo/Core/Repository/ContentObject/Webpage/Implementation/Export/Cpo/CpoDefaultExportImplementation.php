<?php
namespace Chamilo\Core\Repository\ContentObject\Webpage\Implementation\Export\Cpo;

use Chamilo\Core\Repository\Common\Export\ContentObjectExport;
use Chamilo\Core\Repository\ContentObject\Webpage\Implementation\Export\CpoExportImplementation;
