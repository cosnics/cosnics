<?php
namespace Chamilo\Core\Repository\ContentObject\Webpage\Implementation\Import;

use Chamilo\Core\Repository\Common\Import\ContentObjectImport;
use Chamilo\Core\Repository\ContentObject\Webpage\Implementation\ImportImplementation;
