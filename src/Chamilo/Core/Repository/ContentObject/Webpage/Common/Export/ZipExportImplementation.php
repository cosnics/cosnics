<?php
namespace Chamilo\Core\Repository\ContentObject\Webpage\Common\Export;

use Chamilo\Core\Repository\ContentObject\Webpage\Common\ExportImplementation;
...
abstract class ZipExportImplementation extends ExportImplementation
{
    ...
    public function render()
    {
        ...
        $this->get_context()->add_files(
            $this->get_content_object()->get_full_path(), $this->get_content_object()->get_virtual_path() . $filename
        );
    }
