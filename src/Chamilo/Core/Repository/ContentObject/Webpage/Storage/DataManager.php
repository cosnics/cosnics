...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    {
        $condition = new EqualityCondition(
            new PropertyConditionVariable(Webpage::class, Webpage::PROPERTY_HASH), new StaticConditionVariable($hash)
        );
    ...
    public static function is_only_webpage_occurence($storage_path, $path)
    {
        ...
        $conditions[] = new EqualityCondition(
            new PropertyConditionVariable(Webpage::class, Webpage::PROPERTY_PATH), new StaticConditionVariable($path)
        );
        $condition = new AndCondition($conditions);

        $count = \Chamilo\Core\Repository\Storage\DataManager::count_content_objects(
            Webpage::class, new DataClassParameters(condition: $condition)
        );
