<?php
namespace Chamilo\Core\Repository\ContentObject\AssessmentMatchingQuestion\Template;
...
class Template extends \Chamilo\Core\Repository\Common\Template\Template implements TemplateParser
{
     ...
     * @return \core\repository\content_object\assessment_matching_question\Template
     */
    public static function parse(DOMXPath $dom_xpath)
    {
        ...
        $content_object = new AssessmentMatchingQuestion();
