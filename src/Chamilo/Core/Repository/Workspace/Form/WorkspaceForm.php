...
class WorkspaceForm extends FormValidator
{
    ...
    {
        $this->addElement('text', Workspace::PROPERTY_NAME, Translation::get('Name'), ['size' => '50']);

        $this->addRule(
            Workspace::PROPERTY_NAME, Translation::get('ThisFieldIsRequired', null, StringUtilities::LIBRARIES),
            'required'
        );
