    ...
    public function run()
    {
        ...
        $this->tabsCollection->add(
            new LinkTab(
                ...
                $this->get_url([self::PARAM_ACTION => self::ACTION_BROWSE_PERSONAL]),
        ...
        $this->tabsCollection->add(
            new LinkTab(
                ...
                new FontAwesomeGlyph('users', ['fa-lg'], null, 'fas'),
                $this->get_url([self::PARAM_ACTION => self::ACTION_BROWSE_SHARED]),
        ...
        $this->tabsCollection->add(
            new LinkTab(
                ...
                new FontAwesomeGlyph('star', ['fa-lg'], null, 'fas'),
                $this->get_url([self::PARAM_ACTION => self::ACTION_FAVOURITE]),
        ...
        $this->tabsCollection->add(
            new LinkTab(
                ...
                $this->get_url([self::PARAM_ACTION => self::ACTION_CREATE]), $this->get_action() == self::ACTION_CREATE,
                false, LinkTab::POSITION_LEFT, LinkTab::DISPLAY_ICON_AND_TITLE
            )
        );
        ...
        if ($this->get_action() == self::ACTION_UPDATE)
        {
            $this->tabsCollection->add(
                new LinkTab(
                    ...
                    new FontAwesomeGlyph('pencil-alt', ['fa-lg'], null, 'fas'),
                    $this->get_url([self::PARAM_ACTION => self::ACTION_UPDATE]),
        ...
        if ($this->get_action() == self::ACTION_RIGHTS)
        {
            ...
            {
                $icon = new FontAwesomeGlyph('lock', ['fa-lg'], null, 'fas');
            ...
            $this->tabsCollection->add(
                new LinkTab(
                    ...
                    $this->get_url([self::ACTION_RIGHTS => self::ACTION_RIGHTS]),
