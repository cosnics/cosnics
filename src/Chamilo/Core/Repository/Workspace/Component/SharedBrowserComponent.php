 ...
 */
class SharedBrowserComponent extends TabComponent
{
    ...
    {
        $totalNumberOfItems = $this->getWorkspaceService()->countSharedWorkspacesForUser($this->getUser());
        ...
        $workspaces = $this->getWorkspaceService()->getSharedWorkspacesForUser(
