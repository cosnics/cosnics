 ...
 */
class GroupRightsTableDataProvider extends DataClassTableDataProvider
{
    ...
    public function retrieve_data($condition, $offset, $count, $order_property = null)
    {
        ...
        return \Chamilo\Core\Repository\Storage\DataManager :: get_content_object_group_shares(
            $content_object_id, 
            $user_id);
    }
    ...
    public function count_data($condition)
    {
        ...
        $user_id = Session :: get_user_id();
        return \Chamilo\Core\Repository\Storage\DataManager :: count_content_object_group_shares(
            $content_object_id, 
            $user_id);
    }
}
