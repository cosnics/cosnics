<?php
namespace Chamilo\Core\Repository\Implementation\Office365\Menu;

use Chamilo\Core\Repository\Implementation\Office365\DataConnector;
...
class CategoryTreeMenu extends GenericTree
{
    ...
    {
        return $this->get_connector()->retrieveFolder($node_id);
    }

    public function get_node_children($parent_node_id)
    {
        return $this->get_connector()->retrieveChildFolder($parent_node_id);
    }
    ...
    {
        return $this->get_connector()->getRootFolderId();
    }
