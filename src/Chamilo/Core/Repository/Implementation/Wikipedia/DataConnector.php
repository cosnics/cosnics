...
use Chamilo\Core\Repository\Implementation\Wikipedia\DataConnector\RestClient;
...
class DataConnector extends \Chamilo\Core\Repository\External\DataConnector
{
    ...
    public function __construct($external_repository_instance)
    {
        ...
        $this->wikipedia = new RestClient($url);
    ...
    public function login()
    {
        ...
        $this->wikipedia->request(RestClient :: METHOD_POST, null, $parameters);
    }
    ...
    public function retrieve_external_repository_objects($condition = null, $order_property, $offset, $count)
    {
        ...
        $result = $this->wikipedia->request(RestClient :: METHOD_GET, null, $parameters);
