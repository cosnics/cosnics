...
class phpVimeo
{
     ...
     * Cache a response.
     * 
     * @param $params array The parameters for the response.
     * @param $response string The serialized response data.
     */
     ...
     * 
     * @param $oauth_params array The OAuth parameters for the call.
     ...
     * 
     * @param $args array The full list of args to generate the signature for.
     * @param $request_method string The request method, either POST or GET.
     * @param $url string The base URL to use.
     ...
     * 
     * @param $params array The full list of api parameters for the request.
     */
     ...
     * @param $call_params array The parameters to pass to the method.
     * @param $request_method string The HTTP request method to use.
     * @param $url string The base URL to use.
     * @param $cache boolean Whether or not to cache the response.
     * @param $use_auth_header boolean Use the OAuth Authorization header to pass the OAuth params.
     ...
     * 
     * @param $perms string The level of permissions to request: read, write, or delete.
     */
     ...
     * Enable the cache.
     * 
     * @param $type string The type of cache to use (phpVimeo::CACHE_FILE is built in)
     * @param $path string The path to the cache (the directory for CACHE_FILE)
     * @param $expire int The amount of time to cache responses (default 10 minutes)
     */
    ...
    /**
     * Get an access token.
     * Make sure to call setToken() with the request token before calling this function.
     * 
     * @param $verifier string The OAuth verifier returned from the authorization page or the user.
     */
     ...
     * 
     * @param $token string The request token.
     * @param $permission string The level of permissions to request: read, write, or delete.
     * @param $callback_url string The URL to redirect the user back to, or oob for the default.
     ...
     * @param $token_secret string The OAuth token secret
     * @param $type string The type of token, either request or access
     * @param $session_store boolean Store the token in a session variable
     * @return boolean true
     */
     ...
     * @param $use_multiple_chunks boolean Whether or not to split the file up into smaller chunks
     * @param $chunk_temp_dir string The directory to store the chunks in
     * @param $size int The size of each chunk in bytes (defaults to 2MB)
     ...
     * 
     * @param $input array/string A parameter or set of parameters to encode.
     */
