...
class API
{
     ...
     * @param $OAuth OAuth\Consumer
     * @param $root string Dropbox app access type
     */
     ...
     * Dropbox impose a 150MB limit to files uploaded via the API.
     * If the file
     * exceeds this limit or does not exist, an Exception will be thrown
     * 
     * @param $file string Absolute path to the file to be uploaded
     * @param $filename string|bool The destination filename of the uploaded file
     * @param $path string Path to upload the file to, relative to root
     * @param $overwrite boolean Should the file be overwritten? (Default: true)
     * @return object stdClass
     */
     ...
     * @param $stream resource A readable stream created using fopen()
     * @param $filename string The destination filename, including path
     * @param $overwrite boolean Should the file be overwritten? (Default: true)
     * @return array
     */
    ...
    /**
     * Downloads a file
     * Returns the base filename, raw file data and mime type returned by
     * Fileinfo
     * 
     * @param $file string Path to file, relative to root, including path
     * @param $outFile string Filename to write the downloaded file to
     * @param $revision string The revision of the file to retrieve
     * @return array
     */
     ...
     * 
     * @param $path string The path to the file/folder, relative to root
     * @param $rev string Return metadata for a specific revision (Default: latest rev)
     * @param $limit int Maximum number of listings to return
     * @param $hash string Metadata hash to compare against
     * @param $list bool Return contents field with response
     * @param $deleted bool Include files/folders that have been deleted
     * @return object stdClass
     */
     ...
     * 
     * @param $cursor null|string Used to keep track of your current state
     ...
     * 
     * @param $file string Path to the file, relative to root
     * @param $revision string The revision of the file to restore
     * @return object stdClass
     */
     ...
     * 
     * @param $query mixed The search string. Must be at least 3 characters long
     * @param $path string The path to the folder you want to search in
     * @param $limit integer Maximum number of results to return (1-1000)
     * @param $deleted boolean Include deleted files/folders in the search
     * @return array
     */
     ...
     * download the file if they wish.
     * For direct download links, see media().
     * 
     * @param $path string The path to the file/folder you want a sharable link to
     * @return object stdClass
     */
     ...
     * 
     * @param $path string The path to the media file you want a direct link to
     * @return object stdClass
     */
     ...
     * 
     * @param $file string The path to the image you wish to thumbnail
     * @param $format string The thumbnail format, either JPEG or PNG
     * @param $size string The size of the thumbnail
     * @return array
     */
     ...
     * 
     * @param $from string File or folder to be copied, relative to root
     * @param $to string Destination path, relative to root
     * @param $fromCopyRef null|string Must be used instead of the from_path
     * @return object stdClass
     */
     ...
     * 
     * @param $path string The path to the file or folder to be deleted
     * @return object stdClass
     */
     ...
     * 
     * @param $from string File or folder to be moved, relative to root
     * @param $to string Destination path, relative to root
     * @return object stdClass
     */
     ...
     * @param $call string The API method to call
     ...
     * 
     * @param $format string One of php, json or jsonp
     * @return void
     */
     ...
     * 
     * @param $data string File contents as a string or filename
     * @param $isFilename string Is $data a filename?
     * @return boolean string type and encoding of the file
     */
