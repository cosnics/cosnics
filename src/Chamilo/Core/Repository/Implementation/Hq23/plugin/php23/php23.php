    ...
    class php23
    {
        ...
        function cache($request, $response)
        {
            ...
            if ($this->cache == 'db')
            {
                ...
                {
                    $sql = "INSERT INTO " . $this->cache_table . " (request, response, expiration) VALUES ('$reqhash', '" . str_replace(
                        "'", 
                        "''", 
        ...
        function buildPhotoURL($photo, $size = "Medium")
        {
            ...
            if ($size == "original")
            {
                $url = "http://farm" . $photo['farm'] . ".static.flickr.com/" . $photo['server'] . "/" . $photo['id'] .
        ...
        {
            /*
             * I've added this method to get the friendly geodata (i.e. 'in New York, NY') that the website provides,
             * but isn't available in the API. I'm providing this service as long as it doesn't flood my server with
             * requests and crash it all the time.
             */
            return unserialize(
                file_get_contents('http://phpflickr.com/geodata/?format=php&lat=' . $lat . '&lon=' . $lon));
        }
        ...
        // } else {
        // header("Location: http://www.flickr.com/services/auth/?api_key=" . $this->api_key . "&perms=" . $perms .
        // "&api_sig=". $api_sig);
        // }
        // exit;
        // } else {
         ...
         * calls to arbitrary methods that haven't been implemented in php23 yet. *****************************
         */
        ...
        function favorites_getList($user_id = NULL, $min_fave_date = NULL, $max_fave_date = NULL, $extras = NULL, $per_page = NULL, 
            $page = NULL)
        {
            /*
        ...
        function favorites_getPublicList($user_id, $min_fave_date = NULL, $max_fave_date = NULL, $extras = NULL, $per_page = NULL, 
            $page = NULL)
        {
            /*
        ...
        function interestingness_getList($date = NULL, $extras = NULL, $per_page = NULL, $page = NULL)
        {
            ...
            $this->request(
                ...
                array("date" => $date, "extras" => $extras, "per_page" => $per_page, "page" => $page));
            return $this->parsed_response ? $this->parsed_response['photos'] : false;
        }
        ...
        function photos_getNotInSet($min_upload_date = NULL, $max_upload_date = NULL, $min_taken_date = NULL, $max_taken_date = NULL, 
        ...
        function photos_getRecent($extras = NULL, $per_page = NULL, $page = NULL)
        {
            ...
            $this->request(
                ...
                array("extras" => $extras, "per_page" => $per_page, "page" => $page));
            return $this->parsed_response ? $this->parsed_response['photos'] : false;
        }
        ...
        function places_placesForBoundingBox($bbox, $place_type = NULL, $place_type_id = NULL)
        {
            ...
            return $this->call(
                ...
                array('bbox' => $bbox, 'place_type' => $place_type, 'place_type_id' => $place_type_id));
        }
