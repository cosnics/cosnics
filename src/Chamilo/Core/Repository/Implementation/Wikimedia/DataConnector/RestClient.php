<?php
namespace Chamilo\Core\Repository\Implementation\Wikimedia\DataConnector;
...
class RestClient extends \Chamilo\Libraries\Protocol\Webservice\Rest\Client\RestClient
{
    ...
    private $wikimedia_url;
    const METHOD_POST = 'POST';
    const METHOD_GET = 'GET';
    const METHOD_PUT = 'PUT';

    public function __construct($wikimedia_url)
    {
        parent :: __construct();

        $this->wikimedia_url = $wikimedia_url;
    }
