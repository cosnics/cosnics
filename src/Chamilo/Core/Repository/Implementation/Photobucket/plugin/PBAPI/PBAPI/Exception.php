<?php
/**
 * Photobucket API Fluent interface for PHP5 PBAPI exception class
 * 
 * @author jhart
 * @package PBAPI
...
class PBAPI_Exception extends Exception
{
     ...
     * @param $code int|PBAPI
     * @param $core PBAPI|optional
     */
    ...
    {
        if ($this->core)
            return $this->core->_getMethodStack();
        else
            return array();
    }
