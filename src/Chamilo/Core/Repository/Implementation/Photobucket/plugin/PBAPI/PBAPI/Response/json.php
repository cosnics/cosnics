<?php
/**
 * Photobucket API Fluent interface for PHP5 json response parser
 * 
 * @author Photobucket
 * @package PBAPI
 * @subpackage Response
...
/**
 * Response json format parser Requires either the JSON extension, or the Services_JSON class from PEAR
 * 
 * @package PBAPI
 * @subpackage Response
 */
