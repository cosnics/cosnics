...
class ContentObject extends CompositeDataClass
{
    ...
    public function get_icon_image($size = Theme :: ICON_SMALL, $is_available = true)
    {
        ...
        return static :: icon_image(ClassnameUtilities::getInstance()->getNamespaceParent($this->context(), 2), $size, $this->is_current() && $is_available, $type_string);
    }
    ...
    {
        return static :: icon_path(ClassnameUtilities::getInstance()->getNamespaceParent($this->context(), 2), $size, $this->is_current());
    }
