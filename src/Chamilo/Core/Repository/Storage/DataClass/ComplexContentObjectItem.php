...
class ComplexContentObjectItem extends CompositeDataClass implements DisplayOrderDataClassListenerSupport
{
    ...
    {
        return \Chamilo\Core\Repository\Storage\DataManager :: retrieve_content_object($this->get_parent());
    }
    ...
    public function check_before_save()
    {
        ...
        {
            $ref_content_object = DataManager :: retrieve_content_object($this->get_ref());
        ...
        {
            $parent_content_object = DataManager :: retrieve_content_object($this->get_parent());
