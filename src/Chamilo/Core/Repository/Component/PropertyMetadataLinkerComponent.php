...
/**
 * This component executes the ContentObjectPropertyMetadataLinker Submanager
 *
 * @package repository
 * @author Sven Vanpoucke - Hogeschool Gent
 */
class PropertyMetadataLinkerComponent extends Manager implements ApplicationSupport
{
    ...
    public function run()
    {
        $factory = new ApplicationFactory(
            $this->getRequest(),
            \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\Linker\Property\Manager :: context(),
            $this->get_user(),
            $this);
        return $factory->run();
    }
