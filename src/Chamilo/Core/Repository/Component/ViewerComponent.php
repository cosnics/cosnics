                ...
                if (! $in_recycle_bin)
                {
                         ...
                         $object->get_state() != ContentObject :: STATE_RECYCLED && $is_owner)
                    {
                        $force_delete_button = new ToolbarItem(
                            ...
                            Theme :: getInstance()->getCommonImagePath() . 'action_unlink.png',
                            $delete_link_url,
                            ToolbarItem :: DISPLAY_ICON_AND_LABEL,
                            true);
                    }
                        ...
                        if (! $hide_sharing)
                        {
                            $action_bar->add_common_action(
                                new ToolbarItem(
                                    ...
                                    Theme :: getInstance()->getCommonImagePath() . 'action_share.png',
                    ...
                    if ($is_owner)
                    {
                        ...
                        $action_bar->add_common_action(
                            new ToolbarItem(
                                ...
                                Theme :: getInstance()->getCommonImagePath() . 'action_restore.png',
                                $restore_url,
                                ToolbarItem :: DISPLAY_ICON_AND_LABEL,
                                true));
            ...
            if ($user->is_platform_admin())
            {
                $action_bar->add_tool_action(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getCommonImagePath() . 'export_template.png',
                        $this->get_url(
                            array(
    ...
    public function add_links_to_content_object_tabs($content_object)
    {
        ...
        if ($content_object->is_external())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_external_instance.png',
                    $browser->as_html()));
        }
        ...
        if ($content_object->has_publications())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_publications.png',
                    $browser->as_html()));
        }
        // EXPORT
        ...
        $this->tabs->add_tab(
            new DynamicContentTab(
                ...
                Theme :: getInstance()->getImagePath() . 'place_mini_export.png',
        ...
        if ($content_object->has_parents())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_parents.png',
                    $browser->as_html()));
        }
        ...
        if ($content_object->has_children())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_children.png',
                    $browser->as_html()));
        }
        ...
        if ($content_object->has_attachers())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_attached_to.png',
                    $browser->as_html()));
        }
        ...
        if ($content_object->has_attachments())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_attaches.png',
                    $browser->as_html()));
        }
        ...
        if ($content_object->has_includers())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_included_in.png',
                    $browser->as_html()));
        }
        ...
        if ($content_object->has_includes())
        {
            ...
            $this->tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'place_mini_includes.png',
                    $browser->as_html()));
        }
    }
