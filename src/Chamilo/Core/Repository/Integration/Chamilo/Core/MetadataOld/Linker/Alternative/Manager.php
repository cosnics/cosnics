<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Alternative;
...
abstract class Manager extends Application
{
    ...
    protected function get_allowed_metadata_elements($content_object_ids = array())
    {
        ...
        return \Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Type\Storage\DataManager :: get_common_metadata_elements(
