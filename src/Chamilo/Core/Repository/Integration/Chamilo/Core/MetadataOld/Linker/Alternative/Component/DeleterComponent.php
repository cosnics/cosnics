...
/**
 * Controller to delete a ContentObjectAlternative
 * 
...
class DeleterComponent extends Manager
{
    ...
    public function run()
    {
        ...
        try
        {
            $content_object_rel_metadata_element_ids = $this->get_content_object_alternative_id_from_request();
            ...
            {
                $content_object_rel_metadata_element = $this->get_content_object_alternative_by_id(
