<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Property;
...
abstract class IntegrationInstaller extends \Chamilo\Configuration\Package\Action\Installer
{
        ...
        $element_name)
    {
        try
        {
            ...
            $element = \Chamilo\Core\MetadataOld\Storage\DataManager :: retrieve_element_by_schema_namespace_and_element_name(
