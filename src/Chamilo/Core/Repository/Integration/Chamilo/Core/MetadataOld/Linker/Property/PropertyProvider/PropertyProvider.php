<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Property\PropertyProvider;
    ...
    public function render_property($property, ContentObject $content_object)
    {
        switch ($property)
        {
            ...
            case self :: PROPERTY_IDENTIFIER :
                return 'Chamilo\Core\Repository\ContentObject:' . $content_object->get_id();
        }
