<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Property\Form;
...
use Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Property\Storage\DataManager;
        ...
        ContentObjectPropertyRelMetadataElement $content_object_property_rel_metadata_element = null)
    {
        ...
        $javascript[] = ResourceManager :: get_instance()->get_resource_html(
            Path :: getInstance()->namespaceToFullPath(
                'Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Property',
        ...
        $metadata_elements = \Chamilo\Core\MetadataOld\Storage\DataManager :: retrieve_element_names_with_schema_namespaces();
