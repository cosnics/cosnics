<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Component;

use Chamilo\Core\MetadataOld\Value\Element\Form\ElementValueEditorFormBuilder;
use Chamilo\Core\MetadataOld\Value\Element\Form\Handler\ElementValueEditorFormHandler;
...
use Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\ContentObjectMetadataValueCreator;
use Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Manager;
use Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Storage\DataManager;
...
class MetadataBatchEditorComponent extends Manager
{
    ...
    public function run()
    {
        ...
        $selected_elements = \Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Linker\Type\Storage\DataManager :: get_common_metadata_elements(
