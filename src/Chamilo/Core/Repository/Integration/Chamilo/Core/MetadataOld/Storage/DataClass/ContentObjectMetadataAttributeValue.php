<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\MetadataOld\Storage\DataClass;

use Chamilo\Core\MetadataOld\Value\Storage\DataClass\AttributeValue;

/**
 * Class to store the attribute values for the given content object
 * 
 * @package repository\integration\core\metadata
 * @author Sven Vanpoucke - Hogeschool Gent
 */
class ContentObjectMetadataAttributeValue extends AttributeValue
{
