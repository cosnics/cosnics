...
/**
 * Controller to delete a ContentObjectRelMetadataElement
 * 
...
class DeleterComponent extends Manager
{
    ...
    public function run()
    {
        ...
        try
        {
            $content_object_rel_metadata_element_ids = $this->get_content_object_rel_metadata_element_id_from_request();
            ...
            {
                $content_object_rel_metadata_element = $this->get_content_object_rel_metadata_element_by_id(
