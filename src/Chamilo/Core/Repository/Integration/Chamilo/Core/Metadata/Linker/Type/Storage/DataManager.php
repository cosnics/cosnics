<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\Linker\Type\Storage;
...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    public static function retrieve_metadata_elements_for_content_object_type($content_object_type)
    {
        ...
        $records = \Chamilo\Core\Metadata\Storage\DataManager :: records(Element :: class_name(), $parameters);
    ...
    public static function get_common_metadata_elements(array $content_objects)
    {
        ...
        $elements = \Chamilo\Core\Metadata\Storage\DataManager :: retrieves(
            Element :: class_name(), 
            new InCondition(
                new PropertyConditionVariable(Element :: class_name(), Element :: PROPERTY_ID), 
