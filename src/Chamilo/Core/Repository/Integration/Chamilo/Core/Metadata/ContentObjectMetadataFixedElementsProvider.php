<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata;
...
class ContentObjectMetadataFixedElementsProvider implements FixedElementsProvider
{
    ...
    public function get_fixed_elements()
    {
        ...
        foreach ($this->get_property_providers() as $property_provider)
        {
            ...
            $properties = \Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\Linker\Property\Storage\DataManager :: retrieve_content_object_property_rel_metadata_elements_by_content_object_type(
    ...
    protected function get_property_providers()
    {
        ...
        $property_provider_base_namespace = '\integration\repository\content_object_metadata_element_linker\PropertyProvider';
        
        $property_providers[] = '\core\repository' . $property_provider_base_namespace;
