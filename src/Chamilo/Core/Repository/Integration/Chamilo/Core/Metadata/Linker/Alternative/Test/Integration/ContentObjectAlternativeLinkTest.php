<?php
namespace Chamilo\Core\Repository\Integration\Chamilo\Core\Metadata\Linker\Alternative\Test\Integration;
...
class ContentObjectAlternativeLinkTest extends Test
{
    ...
    protected static function retrieve_metadata_elements()
    {
        ...
        {
            self :: $metadata_elements[$element_name] = \Chamilo\Core\Metadata\Storage\DataManager :: retrieve_element_by_fully_qualified_element_name(
                $element_name);
        }
    }
