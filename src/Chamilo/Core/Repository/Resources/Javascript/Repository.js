(function($) {
    ...
    $(document).ready(function() {
        ...
        $(document).on('mouseenter', "table.gallery_table > tbody > tr > td", function(i) {
            $("div.thumbnail_actions", this).show();
        });
        $(document).on('mouseleave', "table.gallery_table > tbody > tr > td", function(i) {
            $("div.thumbnail_actions", this).hide();
        });
        $(document).on('click', "table.data_table > tbody > tr > td > input.repository_version_browser_table_id:checkbox", checkCompareCheckboxes);
    });
