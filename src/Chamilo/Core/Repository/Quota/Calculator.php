...
class Calculator
{
     ...
     */
    public function __construct(User $user, $reset = false, GroupSubscriptionService $groupSubscriptionService = null)
    {
        if (!$groupSubscriptionService instanceof GroupSubscriptionService)
        {
    ...
    {
        $userGroupIds = $this->groupSubscriptionService->findAllGroupIdsForUser($this->user);
