...
class VersionTableCellRenderer extends DataClassTableCellRenderer implements TableCellRendererActionsColumnSupport
{
    ...
    public function get_actions($content_object)
    {
            ...
            if ($remove_url)
            {
                $toolbar->add_item(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getCommonImagePath() . 'action_remove.png', 
                        $remove_url, 
                        ToolbarItem :: DISPLAY_ICON));
            }
            else
            {
                $toolbar->add_item(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getCommonImagePath() . 'action_remove_na.png', 
                        null, 
                        ToolbarItem :: DISPLAY_ICON));
            }
        }
        ...
        if (($content_object->get_owner_id() == $this->get_component()->get_user_id() ||
             RepositoryRights :: get_instance()->is_allowed_in_user_subtree(
            ...
            if ($revert_url)
            {
                $toolbar->add_item(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getCommonImagePath() . 'action_revert.png', 
                        $revert_url, 
                        ToolbarItem :: DISPLAY_ICON));
            }
            else
            {
                $toolbar->add_item(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getCommonImagePath() . 'action_revert_na.png', 
                        null, 
                        ToolbarItem :: DISPLAY_ICON));
            }
        }
