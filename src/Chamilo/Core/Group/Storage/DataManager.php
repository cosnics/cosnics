...
class DataManager extends \Chamilo\Libraries\Storage\DataManager\DataManager
{
    ...
    public static function retrieve_group_by_code($code)
    {
        ...
        return self :: retrieve(Group :: class_name(), $condition);
    }
    ...
    public static function retrieve_all_subscribed_groups_array($user_id, $only_retrieve_ids = false)
    {
        ...
        $parameters = new RecordRetrievesParameters($properties, /* $condition = */ null, /* $count = */ null, /* $offset = */ null,
                /* $order_by = */ null, new Joins(array($join)));
