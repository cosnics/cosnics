                ...
                new ToolbarItem(
                    ...
                    $this->get_component()->get_url(
                        array(
                            ...
                            \Chamilo\Core\MetadataOld\Manager :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_VALUE,
                            \Chamilo\Core\MetadataOld\Value\Manager :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Value\Manager :: ACTION_ATTRIBUTE,
                            Manager :: PARAM_ATTRIBUTE_ID => $result->get_id())),
                    ToolbarItem :: DISPLAY_ICON));
        }
