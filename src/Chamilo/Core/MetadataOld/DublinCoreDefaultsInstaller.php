...
class DublinCoreDefaultsInstaller
{
    ...
    protected function install_schemas()
    {
        ...
        foreach ($schemas as $schema_array)
        {
            try
            {
                $schema = \Chamilo\Core\MetadataOld\Schema\Storage\DataManager :: retrieve_schema_by_namespace(
    ...
    protected function install_dublin_core_elements()
    {
        ...
        {
            $element = \Chamilo\Core\MetadataOld\Storage\DataManager :: retrieve_element_by_schema_id_and_name(
                $schema_id, 
                $element_name);
    ...
    protected function install_dublin_core_attributes()
    {
        ...
        {
            $attribute = \Chamilo\Core\MetadataOld\Storage\DataManager :: retrieve_attribute_by_schema_id_and_name(
                $schema_id, 
                $attribute_name);
