<?php
namespace Chamilo\Core\MetadataOld\Element\Storage\DataClass;
...
class Element extends DataClass implements DisplayOrderDataClassListenerSupport
{
     ...
     * 
     * @var \Chamilo\Core\MetadataOld\attribute\storage\data_class\Attribute[]
     */
    private $attributes;
     ...
     * 
     * @var \Chamilo\Core\MetadataOld\value\element\storage\data_class\DefaultElementValue[]
     */
    ...
    public function get_namespace()
    {
        if (! $this->namespace)
        {
            $schema = \Chamilo\Core\MetadataOld\Storage\DataManager :: retrieve_by_id(
                Schema :: class_name(), 
                $this->get_schema_id());
     ...
     * Sets the attributes
     * 
     * @param \Chamilo\Core\MetadataOld\attribute\storage\data_class\Attribute[] $attributes
     */
     ...
     * 
     * @return \Chamilo\Core\MetadataOld\attribute\storage\data_class\Attribute[]
     */
     ...
     * 
     * @param \Chamilo\Core\MetadataOld\element\storage\data_class\Element[] $nested_elements
     */
     ...
     * 
     * @param \Chamilo\Core\MetadataOld\value\element\storage\data_class\DefaultElementValue[] $default_values
     */
     ...
     * 
     * @return \Chamilo\Core\MetadataOld\value\element\storage\data_class\DefaultElementValue[]
     */
