...
use Chamilo\Core\MetadataOld\ControlledVocabulary\Form\RelationForm;
    ...
    public function run()
    {
        ...
        if ($form->validate())
        {
            try
            {
                ...
                foreach ($values[\Chamilo\Core\MetadataOld\ControlledVocabulary\Manager :: PARAM_CONTROLLED_VOCABULARY_ID][\Chamilo\Core\MetadataOld\ControlledVocabulary\Manager :: PARAM_CONTROLLED_VOCABULARY_ID] as $controlled_vocabulary_id)
                {
