<?php
namespace Chamilo\Core\MetadataOld\Integration\Chamilo\Core\Admin;
...
class Manager implements ActionsSupportInterface
{
    ...
    public static function get_actions()
    {
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Core\MetadataOld\Manager :: context(),
                Application :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_SCHEMA));
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Core\MetadataOld\Manager :: context(),
                Application :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_ELEMENT));
        $links[] = new DynamicAction(
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Core\MetadataOld\Manager :: context(),
                Application :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_ATTRIBUTE));
        $links[] = new DynamicAction(
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Core\MetadataOld\Manager :: context(),
                Application :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_CONTROLLED_VOCABULARY));
        $links[] = new DynamicAction(
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Core\MetadataOld\Manager :: context(),
                Application :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_EXPORT_METADATA));
        $links[] = new DynamicAction(
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Chamilo\Core\MetadataOld\Manager :: context(),
                Application :: PARAM_ACTION => \Chamilo\Core\MetadataOld\Manager :: ACTION_IMPORT_METADATA));
        $links[] = new DynamicAction(
        ...
        return new Actions(\Chamilo\Core\MetadataOld\Manager :: context(), $links);
    }
}
