        ...
        while ($registration = $registrations->next_result())
        {
            ...
            $toolbar->add_item(
                new ToolbarItem(
                    ...
                    Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/view.png',
                    $this->get_url(
                        array(
            ...
            if ($registration->is_active())
            {
                    ...
                    'Chamilo\Configuration\Package\NotAllowed'))
                {
                    $toolbar->add_item(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/deactivate.png',
                            $this->get_url(
                                array(
                ...
                $toolbar->add_item(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/upgrade_na.png',
                        null,
                        ToolbarItem :: DISPLAY_ICON));
            }
            else
                    ...
                    'Chamilo\Configuration\Package\NotAllowed'))
                {
                    $toolbar->add_item(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/activate.png',
                            $this->get_url(
                                array(
                ...
                if ($package && version_compare($package->get_version(), $registration->get_version(), '>'))
                {
                    $toolbar->add_item(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/upgrade.png',
                            $this->get_url(
                                array(
            ...
            if (! is_subclass_of($registration->get_context() . '\Remover', 'Chamilo\Configuration\Package\NotAllowed'))
            {
                $toolbar->add_item(
                    new ToolbarItem(
                        ...
                        Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/remove.png',
                        $this->get_url(
                            array(
        ...
        foreach ($packages[$this->current_type] as $package_info)
        {
            ...
            $toolbar->add_item(
                new ToolbarItem(
                    ...
                    Theme :: getInstance()->getImagePath(Manager :: context()) . 'Action/install.png',
                    $this->get_url(
                        array(
    ...
    public function get_action_bar()
    {
        ...
        $action_bar->add_common_action(
            new ToolbarItem(
                ...
                Theme :: getInstance()->getImagePath(\Chamilo\Core\Lynx\Source\Manager :: context()) . 'Logo/16.png',
                $this->get_url(
                    array(
        ...
        $action_bar->add_common_action(
            new ToolbarItem(
                ...
                Theme :: getInstance()->getImagePath(\Chamilo\Core\Lynx\Remote\Manager :: context()) . 'Logo/16.png',
                $this->get_url(
                    array(
