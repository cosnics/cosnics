                    ...
                    'configuration\package\NotAllowed'))
                {
                    $action_bar->add_common_action(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getImagePath() . 'action/deactivate.png',
                            $this->get_url(
                                array(
                    ...
                    'configuration\package\NotAllowed'))
                {
                    $action_bar->add_common_action(
                        new ToolbarItem(
                            ...
                            Theme :: getInstance()->getImagePath() . 'action/activate.png',
                            $this->get_url(
                                array(
        ...
        else
        {
            $action_bar->add_common_action(
                new ToolbarItem(
                    ...
                    Theme :: getInstance()->getImagePath() . 'action/install.png',
                    $this->get_url(
