 ...
 * @template-implements Collection<TKey,\Chamilo\Libraries\Storage\Architecture\Domain\Query\Join>
 * @template-implements Selectable<TKey,\Chamilo\Libraries\Storage\Architecture\Domain\Query\Join>
