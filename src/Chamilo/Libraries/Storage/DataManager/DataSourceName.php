...
abstract class DataSourceName
{
     ...
     */
    public function __construct($driver, $username, $host, $database, $password = null, $port = null)
    {
        $this->driver = $driver;
    ...
    public static function get_from_config($type)
    {
        return self :: factory(
            $type, 
            \Chamilo\Configuration\Configuration :: get('Chamilo\Configuration', 'database', 'driver'), 
            \Chamilo\Configuration\Configuration :: get('Chamilo\Configuration', 'database', 'username'), 
            \Chamilo\Configuration\Configuration :: get('Chamilo\Configuration', 'database', 'host'), 
            \Chamilo\Configuration\Configuration :: get('Chamilo\Configuration', 'database', 'name'), 
            \Chamilo\Configuration\Configuration :: get('Chamilo\Configuration', 'database', 'password'));
    }
     ...
     * @return \Chamilo\Libraries\Storage\DataManager\DataSourceName
     */
    public static function factory($type, $driver, $username, $host, $database, $password = null, $port = null)
    {
        $class = __NAMESPACE__ . '\\' . $type . '\DataSourceName';
        return new $class($driver, $username, $host, $database, $password, $port);
    }
