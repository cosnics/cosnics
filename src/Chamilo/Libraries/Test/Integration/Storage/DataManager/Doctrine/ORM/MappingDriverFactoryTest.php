...
class MappingDriverFactoryTest extends DependencyInjectionBasedTestCase
{
    ...
    {
        $mapping = [
            'default' => ['Chamilo/Libraries/Test/Integration/Storage/DataManager/Doctrine/ORM/config'],
            'custom' => [
                'common_libraries_test' => [
                    'type' => $driverType,
                    'namespace' => 'common\libraries\test',
                    'paths' => ['Chamilo/Libraries/Test/Integration/Storage/DataManager/Doctrine/ORM/']
                ]
            ]
        ];
    ...
    public function testDefaultDriverPaths()
    {
        ...
        $this->assertEquals(
            [$systemPathBuilder->getBasePath() . $mapping['default'][0]], $mappingDriver->getPaths()
        );
    }
