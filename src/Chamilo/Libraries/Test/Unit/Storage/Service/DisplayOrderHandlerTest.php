...
class DisplayOrderHandlerTest extends ChamiloTestCase
{
    ...
    {
        $this->displayOrderRepositoryMock =
            $this->getMockBuilder(DisplayOrderRepository::class)->disableOriginalConstructor()->getMock();
    ...
    public function testCreate()
    {
        ...
        $this->displayOrderRepositoryMock->expects($this->once())->method('findNextDisplayOrderValue')->with(
                $displayOrderDataClass
    ...
    public function testCreateWithExistingDisplayOrder()
    {
        ...
        $this->displayOrderRepositoryMock->expects($this->once())->method('countOtherDisplayOrdersInContext')->with(
                $displayOrderDataClass
            )->will($this->returnValue(15));

        $this->displayOrderRepositoryMock->expects($this->once())->method('addDisplayOrderToContext')->with(
                $displayOrderDataClass
    ...
    public function testDelete()
    {
        ...
        $this->displayOrderRepositoryMock->expects($this->once())->method('deleteDisplayOrderFromContext')->with(
                $displayOrderDataClass, [DisplayOrderDataClassStub::PROPERTY_PARENT_ID => 0], 5
            )->will($this->returnValue(true));
    ...
    public function testUpdateWithContextChanged()
    {
        ...
        $this->displayOrderRepositoryMock->expects($this->once())->method('findDisplayOrderPropertiesRecord')->will(
                $this->returnValue(
        ...
        $this->displayOrderRepositoryMock->expects($this->once())->method('deleteDisplayOrderFromContext')->with(
                $displayOrderDataClass, [DisplayOrderDataClassStub::PROPERTY_PARENT_ID => 0], 3
            )->will($this->returnValue(true));
    ...
    public function testUpdateWithContextChangedFailsToDecrementPreviousDisplayOrders()
    {
        ...
        $this->displayOrderRepositoryMock->expects($this->never())->method('addDisplayOrderToContext');
    ...
    public function testUpdateWithDisplayOrderChangedButFailsToDecrementPreviousDisplayOrders()
    {
        ...
        $this->displayOrderRepositoryMock->expects($this->never())->method('addDisplayOrderToContext')->with(
                $displayOrderDataClass
            );
