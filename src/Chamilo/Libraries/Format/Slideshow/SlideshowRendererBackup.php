...
class SlideshowRendererBackup
{
     ...
     * @throws \Exception
     */
    protected function determineUrl(int $slideshowIndex, int $slideshowAutoPlay): string
    {
     ...
     * @throws \Exception
     */
    protected function renderButtonToolbar(): string
    {
        $slideshowIndex = $this->getSlideshowIndex();
     ...
     * @throws \Exception
     */
    protected function renderNextNavigation(): string
    {
        $html = [];
     ...
     * @throws \Exception
     */
    protected function renderPreviousNavigation(): string
    {
        $html = [];
     ...
     * @throws \Exception
     */
    protected function renderSlidshowAutoplay(): string
    {
        $slideshowAutoplay = $this->getSlideshowAutoPlay();
