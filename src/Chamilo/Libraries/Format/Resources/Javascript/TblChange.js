...
function initCalendar(day_of_month_identifier) 
{
    ...
    str += '</th><th class="monthyear" width="50%">'; str += '<a href="javascript:year--; initCalendar(' + day_of_month_identifier + ');">&laquo;</a> '; 
    str += year;
...
{ 
    ...
    datevalues[2].selectedIndex = datevalues[2].length - (datevalues[2].options[datevalues[2].length-1].value - y) - 1; // selectedIndex = numberOfItems - (maxYear - selectedYear) - 1;
	window.close(); 
