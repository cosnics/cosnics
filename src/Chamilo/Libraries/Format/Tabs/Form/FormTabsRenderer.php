...
class FormTabsRenderer
{
    ...
    /**
     *
     * @var \Chamilo\Libraries\Format\Tabs\Form\FormTab[]
     */
    private array $tabs;

    public function __construct(string $name, FormValidator $form)
    {
        $this->name = $name;
        $this->tabs = [];
        $this->form = $form;
    ...
    public function addTab(FormTab $tab)
    {
        $tab->setIdentifier($this->getName() . '-' . $tab->getIdentifier());
        $this->tabs[] = $tab;
    }
  ...
  $(this).tab(\'show\')
    ...
    /**
     * @return \Chamilo\Libraries\Format\Tabs\Form\FormTab[]
     */
