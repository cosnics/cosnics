...
class SymfonyFormFactoryBuilder
{
     ...
     * 
     * @param Twig_Environment $twig
     * @param $chamilo_form_templates_path
     * @throws \InvalidArgumentException
     */
    protected function addTwigLoader(\Twig_Environment $twig, $chamilo_form_templates_path)
    {
        $vendorTwigBridgeDir = Path::getInstance()->getBasePath() . '../vendor/symfony/twig-bridge/';
        
        $form_loader = new Twig_Loader_Filesystem(
            array($chamilo_form_templates_path, $vendorTwigBridgeDir . '/Resources/views/Form'));
     ...
     * @param $chamilo_form_templates_path
     */
    protected function addTwigExtension(\Twig_Environment $twig, $chamilo_form_templates_path)
    {
        $chamilo_files = Filesystem::get_directory_content($chamilo_form_templates_path, Filesystem::LIST_FILES, false);
