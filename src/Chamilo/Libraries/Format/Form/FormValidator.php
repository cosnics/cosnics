...
EOT;
	...
	<div class="form-row row">
		<div class="col-12 col-sm-4 col-md-3 col-lg-2 form-label"></div>
		<div class="col-12 col-sm-8 col-md-9 col-lg-10 formw">{requiredNote}</div>
	</div>
EOT;
    ...
    public function getElementTemplate($extraClasses = null)
    {
        ...
        $element_template[] = '<div class="col-12 col-sm-4 col-md-3 col-lg-2 form-label control-label">';
        ...
        $element_template[] = '<div class="col-12 col-sm-8 col-md-9 col-lg-10 formw">';
        $element_template[] =
    ...
    protected function addMessage($type, $name, $label, $message, $noMargin = false)
    {
        ...
        else
        {
            ...
            $html[] = '</div>';
            $html[] = '<div class="col-12 col-sm-8 col-md-9 col-lg-10 formw">';
        }
...
EOT;
    ...
    )
    {
        ...
        $dropzoneHtml[] =
            '<i class="glyphicon glyphicon-trash"></i> <span>' . $this->getTranslation('Delete') . '</span>';
        $dropzoneHtml[] = '</button>';
