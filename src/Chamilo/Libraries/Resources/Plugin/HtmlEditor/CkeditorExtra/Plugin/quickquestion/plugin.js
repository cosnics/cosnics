CKEDITOR.plugins.add('quickquestion', {
    ...
    init: function (editor) {
        ...
        editor.widgets.add('quickquestion', {
            ...
            '<button type="button" class="btn btn-primary" style="margin-bottom:5px; display: none" onclick="$(\'.an-answer\', $(this).parent()).toggle()">' + editor.lang.quickquestion.showAnswer + '</button>' +
