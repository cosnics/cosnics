...
return static function (ContainerConfigurator $container) {
    ...
    $services->set(DayCalendarTableBuilder::class);
    $services->set(MiniMonthCalendarTableBuilder::class);
    $services->set(MonthCalendarTableBuilder::class);
    $services->set(WeekCalendarTableBuilder::class);
    ...
    $services->set(CalendarTableConfigurationBuilder::class)->args(
        [
            ...
            '$defaultEndHour' => '%cosnics.libraries.calendar.workingHoursEnd%',
            '$defaultStartHour' => '%cosnics.libraries.calendar.workingHoursStart%'
        ]
    );
};
