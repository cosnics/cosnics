        ...
        .extend({
            advelementfinder: function (options) {
                ...
                function setActivateElementsButtonState() {
                    if (settings.maxSelectableItems != null
                        ...
                        $('input.activate_elements', self).addClass(
                            'disabled');
                        $('input.activate_elements', self).attr(
                            'disabled',
                            'disabled'
                        );
                    }
                ...
                function updateElements(is_search) {
                    ...
                    if (result.properties.elements
                        ...
                        if (hasPreviousElements) {
                            var previousDiv = $(
                                '<div class="previous_elements"><span class="fas fa-chevron-circle-up fa-fw fa-lg"></span></div>');
                        ...
                        if (hasNextElements) {
                            var nextDiv = $(
                                '<div class="next_elements"><span class="fas fa-chevron-circle-down fa-fw fa-lg"></span></div>');
                ...
                function createFilterBox() {
                    var div = $('<div>', {
                        'class': 'filter_box form-group'
                    });

                    var filterbox = $('<select class="form-control">');
