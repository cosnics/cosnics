...
CKEDITOR.editorConfig = function(config)
{
    ...
    config.toolbar_Basic = [
            ...
            '/',
            [ 'Link', 'Unlink', '-', 'TextColor', 'BGColor', '-', 'Table', 'Resource', 'Image', 'EmbedSemantic', 'EqnEditor',
