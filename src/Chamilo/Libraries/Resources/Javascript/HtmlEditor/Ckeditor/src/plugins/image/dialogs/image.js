...
(function()
{
    var imageDialog = function(editor, dialogType)
    {
        ...
        var onSizeChange = function()
        {
            ...
            // This = input element.
            dialog = this.getDialog(), aMatch = value.match(regexGetSize); // Check
                                                                            // value
            if (aMatch)
            {
        ...
        // Synchronous field values to other impacted fields is required, e.g.
        // border
        ...
        var switchLockRatio = function(dialog, value)
        {
            ...
            if (value == 'check')
            {
                ...
                {
                    var width = dialog.getValueOf('info', 'txtWidth'), height = dialog.getValueOf('info', 'txtHeight'), originalRatio = oImageOriginal.$.width
                            * 1000 / oImageOriginal.$.height, thisRatio = width * 1000 / height;
        ...
        var resetSize = function(dialog)
        {
            ...
            if (oImageOriginal.getCustomData('isReady') == 'true')
            {
                var widthField = dialog.getContentElement('info', 'txtWidth'), heightField = dialog.getContentElement(
                        'info', 'txtHeight');
        ...
        var setupDimension = function(type, element)
        {
            ...
            var dialog = this.getDialog(), value = '', dimension = this.id == 'txtWidth' ? 'width' : 'height', size = element
        ...
        return {
            ...
            onShow : function()
            {
                ...
                var editor = this.getParentEditor(), sel = editor.getSelection(), element = sel
                        && sel.getSelectedElement(), link = element && editor.elementPath(element).contains('a', 1), loader = CKEDITOR.document
                ...
                else if (element && element.getName() == 'img' && !element.data('cke-realelement') || element
                        && element.getName() == 'input' && element.getAttribute('type') == 'image')
                {
                ...
                {
                    // Use the original element as a buffer from since we don't
                    // want
                    // temporary changes to be committed, e.g. if the dialog is
                    // canceled.
                                        ...
                                        children : [
                                                {
                                                    ...
                                                    onChange : function()
                                                    {
                                                        ...
                                                        if (newUrl.length > 0)
                                                        {
                                                            ...
                                                            if (dialog.preview)
                                                            {
                                                                ...
                                                                dialog.preview.setAttribute('src',
                                                                        previewPreloader.$.src);
                                                                updatePreview(dialog);
                                                            }
                                                        }
                                                        // Dont show preview if
                                                        // no URL given.
                                                    ...
                                                    type : 'button',
                                                    id : 'browse',
                                                    // v-align with the 'txtUrl'
                                                    // field.
                                                    // TODO: We need something
                                                    // better than a fixed size
                                                    // here.
                                                            ...
                                                            children : [
                                                                        ...
                                                                        children : [
                                                                                {
                                                                                    ...
                                                                                    validate : function()
                                                                                    {
                                                                                        var aMatch = this
                                                                                                .getValue()
                                                                                                .match(
                                                                                                        regexGetSizeOrEmpty), isValid = !!(aMatch && parseInt(
                                                                                                aMatch[1], 10) !== 0);
                                                                                        if (!isValid)
                                                                                            alert(editor.lang.common.invalidWidth); // jshint
                                                                                                                                    // ignore:line
                                                                                        return isValid;
                                                                                    },
                                                                                ...
                                                                                },
                                                                                {
                                                                                    ...
                                                                                    validate : function()
                                                                                    {
                                                                                        var aMatch = this
                                                                                                ...
                                                                                                aMatch[1], 10) !== 0);
                                                                                        if (!isValid)
                                                                                            alert(editor.lang.common.invalidHeight); // jshint
                                                                                                                                        // ignore:line
                                                                                        return isValid;
                                                                                    },
                                                                                    setup : setupDimension,
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        onLoad : function()
                                                                        {
                                                                            ...
                                                                            // Reset
                                                                            // button
                                                                            var resetButton = CKEDITOR.document
                                                                                    .getById(btnResetSizeId), ratioButton = CKEDITOR.document
                                                                                ...
                                                                                ratioButton
                                                                                        .on(
                                                                                                ...
                                                                                                function(evt)
                                                                                                {
                                                                                                    ...
                                                                                                    var oImageOriginal = this.originalElement, width = this
                                                                                                            .getValueOf(
                                                                                                                    'info',
                                                                                                                    'txtWidth');
                                                                                                    ...
                                                                                                    if (oImageOriginal
                                                                                                            ...
                                                                                                            && width)
                                                                                                    {
                                                                                                        var height = oImageOriginal.$.height
                                                                                                                / oImageOriginal.$.width
                                                                                                                * width;
                                                                                                        if (!isNaN(height))
                                                                                                        {
                                                            ...
                                                            children : [
                                                                    {
                                                                        ...
                                                                        setup : function(type, element)
                                                                        {
                                                                            if (type == IMAGE)
                                                                            {
                                                                                var value, borderStyle = element
                                                                                        .getStyle('border-width');
                                                                                borderStyle = borderStyle
                                                                                        && borderStyle
                                                                                                .match(/^(\d+px)(?: \1 \1 \1)?$/);
                                                                                value = borderStyle
                                                                                        && parseInt(borderStyle[1], 10);
                                                                        ...
                                                                        commit : function(type, element, internalCommit)
                                                                        {
                                                                            ...
                                                                            if (type == IMAGE || type == PREVIEW)
                                                                            {
                                                                                if (!isNaN(value))
                                                                                {
                                                                                    element.setStyle('border-width',
                                                                                            CKEDITOR.tools
                                                                                                    .cssLength(value));
                                                                                    element.setStyle('border-style',
                                                                                            'solid');
                                                                                }
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        setup : function(type, element)
                                                                        {
                                                                            if (type == IMAGE)
                                                                            {
                                                                                var value, marginLeftPx, marginRightPx, marginLeftStyle = element
                                                                                        .getStyle('margin-left'), marginRightStyle = element
                                                                                ...
                                                                                marginRightStyle = marginRightStyle
                                                                                        && marginRightStyle
                                                                                                .match(pxLengthRegex);
                                                                                marginLeftPx = parseInt(
                                                                                        marginLeftStyle, 10);
                                                                                marginRightPx = parseInt(
                                                                                        marginRightStyle, 10);
                                                                                
                                                                                value = (marginLeftPx == marginRightPx)
                                                                                        && marginLeftPx;
                                                                                isNaN(parseInt(value, 10))
                                                                                        && (value = element
                                                                                                .getAttribute('hspace'));
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        setup : function(type, element)
                                                                        {
                                                                            if (type == IMAGE)
                                                                            {
                                                                                var value, marginTopPx, marginBottomPx, marginTopStyle = element
                                                                                        .getStyle('margin-top'), marginBottomStyle = element
                                                                                ...
                                                                                marginTopPx = parseInt(marginTopStyle,
                                                                                        10);
                                                                                marginBottomPx = parseInt(
                                                                                        marginBottomStyle, 10);
                                                                                
                                                                                value = (marginTopPx == marginBottomPx)
                                                                                        && marginTopPx;
                                                                                isNaN(parseInt(value, 10))
                                                                                        && (value = element
                                                                                                .getAttribute('vspace'));
                                                                        ...
                                                                        commit : function(type, element, internalCommit)
                                                                        {
                                                                            ...
                                                                            if (type == IMAGE || type == PREVIEW)
                                                                            {
                                                                                if (!isNaN(value))
                                                                                {
                                                                                    element.setStyle('margin-top',
                                                                                            CKEDITOR.tools
                                                                                                    .cssLength(value));
                                                                                    element.setStyle('margin-bottom',
                                                                                            CKEDITOR.tools
                                                                                                    .cssLength(value));
                                                                                }
                                                                                else if (!value && this.isChanged())
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        // options.
                                                                        // [
                                                                        // editor.lang.image.alignAbsBottom
                                                                        // ,
                                                                        // 'absBottom'],
                                                                        // [
                                                                        // editor.lang.image.alignAbsMiddle
                                                                        // ,
                                                                        // 'absMiddle'],
                                                                        // [
                                                                        // editor.lang.image.alignBaseline
                                                                        // ,
                                                                        // 'baseline'],
                                                                        // [
                                                                        // editor.lang.image.alignTextTop
                                                                        // ,
                                                                        // 'text-top'],
                                                                        // [
                                                                        // editor.lang.image.alignBottom
                                                                        // ,
                                                                        // 'bottom'],
                                                                        // [
                                                                        // editor.lang.image.alignMiddle
                                                                        // ,
                                                                        // 'middle'],
                                                                        // [
                                                                        // editor.lang.image.alignTop
                                                                        // ,
                                                                        // 'top']
                                                                        ],
                                                                        onChange : function()
                        ...
                        elements : [
                                ...
                                },
                                {
                                    ...
                                    children : [ {
                                        type : 'text',
                                        id : 'txtGenClass',
                                        requiredContent : 'img(cke-xyz)', // Random
                                                                            // text
                                                                            // like
                                                                            // 'xyz'
                                                                            // will
                                ...
                                },
                                {
                                    ...
                                    setup : function(type, element)
                                    {
                                        if (type == IMAGE)
                                        {
                                            ...
                                            var height = element.$.style.height, width = element.$.style.width, aMatchH = (height ? height
                                                    : '').match(regexGetSize), aMatchW = (width ? width : '')
                                                    .match(regexGetSize);
                                    ...
                                    onChange : function()
                                    {
                                        commitInternally.call(this, [ 'info:cmbFloat', 'info:cmbAlign',
                                                'info:txtVSpace', 'info:txtHSpace', 'info:txtBorder', 'info:txtWidth',
                                                'info:txtHeight' ]);
                                        updatePreview(this);
                                    },
                                    commit : function(type, element)
