...
(function($) {
	$.fn.extend({
		tree_menu : function(options) {
			...
			function processTree(parent_element) {
				$("ul li:last-child > div", parent_element).addClass("last");
				$("ul li:last-child > div.expand", parent_element).addClass(
						"lastExpand");
				$("ul li:last-child > div.expand", parent_element).removeClass(
						"expand");
				$("ul li:last-child > ul", parent_element).css(
						"background-image", "none");

				$("ul li:not(:last-child):has(ul) > div", parent_element)
						.addClass("collapse");
				$("ul li:last-child:has(ul) > div", parent_element).addClass(
						"lastCollapse");

				// $("ul li:has(ul) > div", parent).toggle(collapseItem,
				// expandItem);
				$("ul li > div > a", parent_element).click(function(e) {
					e.stopPropagation();
				});
			}
