...
/**
 * Template class.
 * By Nathan Codding of the phpBB group.
...
class MyTemplate
{
     ...
     * Should be called when you're done with it, in order
     ...
     * value of $varname in the root-level.
     * This can be used
     ...
     * Adds a new block iteration with the given
     ...
     * Adds to current assignments, overriding
     ...
     * the uncompiled_code[] hash with its code.
     * Do not compile.
     */
