...
class DataClassGenerator
{
     ...
     */
    public function generate_data_class(
        $location, $classname, $properties, $package, $description, $author,
        $application_name
    )
    {
        ...
        $file = fopen(
            $location . (string) StringUtilities:: getInstance()->createString($classname)->underscored() .
            '.class.php',
            'w+'
        );
        ...
        if ($file)
        {
            ...
            $this->template->assign_vars(
                array(
                    ...
                    'APPLICATION_NAME' => (string) StringUtilities::getInstance()->createString($application_name)
                        ->upperCamelize(),
