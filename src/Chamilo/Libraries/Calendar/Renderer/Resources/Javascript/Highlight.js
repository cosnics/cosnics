$(function()
{
    ...
    function switchVisibility(calendarEvent)
    {
        ...
        var response = $.ajax({
            ...
            data : {
                'application' : calendarVisibilityContext + '\\Ajax',
            ...
            async : false
                ...
                function(json)
                {
                    ...
                    {
                        $(".table-calendar [data-source-key='" + eventSourceKey + "']").toggleClass(
                                'event-container-hidden');
                        
                        $('.table-calendar-list-events')
                                .each(
                                        function(index)
                                        {
                                            var eventContainers = $('ul.list-group .event-container', $(this)).length;
                                            var hiddenEventContainers = $('ul.list-group .event-container-hidden',
                                                    $(this)).length;
