...
class Diagnoser
{
    ...
    public function get_chamilo_data()
    {
        ...
        foreach ($writable_folders as $index => $folder)
        {
            ...
            $array[] = $this->build_setting(
                $status,
                '[FILES]',
                Translation :: get('IsWritable') . ': ' . $folder,
        ...
        $array[] = $this->build_setting(
            ...
            0,
            'yes_no',
            Translation :: get('DirectoryShouldBeRemoved'));

        $date = \Chamilo\Configuration\Configuration :: get('Chamilo\Configuration', 'general', 'install_date');
    ...
    public function get_php_data()
    {
        ...
        $array[] = $this->build_setting(
            ...
            '>= 5.2',
            null,
            Translation :: get('PHPVersionInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            'on_off',
            Translation :: get('OutputBufferingInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            'on_off',
            Translation :: get('FileUploadsInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            'on_off',
            Translation :: get('ShortOpenTagInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            'on_off',
            Translation :: get('MagicQuotesGpcInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            'on_off',
            Translation :: get('DisplayErrorsInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            null,
            Translation :: get('DefaultCharsetInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            null,
            Translation :: get('MaxExecutionTimeInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            null,
            Translation :: get('MaxInputTimeInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            null,
            Translation :: get('MemoryLimitInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            null,
            Translation :: get('PostMaxSizeInfo'));
        ...
        $array[] = $this->build_setting(
            ...
            $req_setting,
            null,
            Translation :: get('VariablesOrderInfo'));
        ...
        foreach ($extensions as $extension => $url)
        {
            ...
            $array[] = $this->build_setting(
                $status,
                '[EXTENSION]',
                Translation :: get('ExtensionLoaded') . ': ' . $extension,
                $url,
                $loaded,
                1,
                'yes_no',
                Translation :: get('ExtensionMustBeLoaded'));
        }
    ...
    public function get_webserver_data()
    {
        ...
        $array[] = $this->build_setting(
            ...
            $path,
            null,
            Translation :: get('RequestURIInfo'));
     ...
     */
    public function build_setting($status, $section, $title, $url, $current_value, $expected_value, $formatter, $comment,
        $img_path = null)
    {
        switch ($status)
        {
