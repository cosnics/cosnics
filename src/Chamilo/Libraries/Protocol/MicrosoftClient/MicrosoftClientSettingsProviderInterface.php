...
interface MicrosoftClientSettingsProviderInterface
{
     ...
     *
     * This string concatenated with 'https://login.microsoftonline.com/<tenant>/oauth2/' makes up the Microsoft authentication service URL.
     *
     ...
     *
     * @return 
     * - Mircosoft OAUTH2: string containing the resource. The App ID URI of the web API. To find the App ID URI of the web API, in the
     *                     Azure Management Portal, click Active Directory, click the directory, click the application and then click Configure.
