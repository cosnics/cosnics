<?php
/*
 * pCache - Faster renderding using data cache Copyright (C) 2008 Jean-Damien POGOLOTTI Version 1.1.2 last updated on
 * 06/17/08 http://pchart.sourceforge.net This program is free software: you can redistribute it and/or modify it under
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>. Class initialisation :
 * pCache($CacheFolder="Cache/") Cache management : IsInCache($Data) GetFromCache($ID,$Data)
 * WriteToCache($ID,$Data,$Picture) DeleteFromCache($ID,$Data) ClearCache() Inner functions : GetHash($ID,$Data)
 */
