...
$ignore = array(// These two lines actually seem to be corrupt
'2.1.1', '2.2.1');

$exceptions = array(// Tests that should mark invalid characters due to using long
...
$longTests = array(// These tests span multiple lines
'3.1.9', '3.2.1', '3.2.2', '3.2.3', '3.2.4', '3.2.5', '3.4');
