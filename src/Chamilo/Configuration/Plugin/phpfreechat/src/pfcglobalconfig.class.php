...
class pfcGlobalConfig
{
    ...
    /**
     * <p>Used to translate the chat text and messages.
     * Accepted values are the <code>i18n/</code> sub directories names.
    ...
    /**
     * <p>If you have already identified the user (forum, portal...) you can force the user's nickname with this
     * parameter.
    ...
    /**
     * <p>Used to create default rooms (auto-joined at startup).
     * It contains an array of rooms names.
    ...
    /**
     * <p>A custom proxies path.
     * Used to easily plugin your own proxy to the chat without modifying the code.
    ...
    /**
     * <p>This is the maximum message length in characters.
     * A longer message is forbidden.
     * (Default value: 400)</p>
     */
    ...
    /**
     * <p>Final width of the shortened URL in characters.
     * (This includes the elipsis on shortened URLs.)
     ...
     * A theme is a package that makes it possible to completly change the chat appearance (CSS) and the chat dynamics
     * (JS)
    ...
    function init()
    {
        ...
        while (false !== ($file = readdir($dh)))
        {
            ...
            if ($file == "." || $file == ".." || ! is_file($f_src))
                continue; // skip . and .. generic files
                              // install js files only if the destination doesn't exists or if the destination timestamp is
                          // older than the source timestamp
