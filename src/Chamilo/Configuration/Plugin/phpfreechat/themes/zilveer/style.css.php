...
echo $c->getFileUrlFromTheme('images/background.gif');
?>");
...
div#pfc_channels_content {
  ...
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/channels_content_bg.png');
?>"); 
  width: 640px;  
}
div.pfc_content {
...
ul#pfc_channels_list li div {
  ...
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/tab_off.png');
?>");
  font-size: 11px;
  font-weight: bold;
...
ul#pfc_channels_list li.selected div {
  ...
  font-size: 11px;
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/tab_on.png');
?>");
...
/*  height: 100%;*/
  ...
  background-color: #FFF;
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/pfc_online.png');
?>");
...
.pfc_oddmsg {
  ...
  color: #000;
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/pfc_message1.png');
?>");
}
.pfc_evenmsg {
  ...
  color: #000;
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/pfc_message2.png');
?>");
}

div.pfc_message {
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/newmsg.png');
?>");
  background-position: right;
...
div.pfc_oldmsg {
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/oldmsg.png');
?>");
  background-position: right;
  background-repeat: no-repeat; 
}
...
div#pfc_input_container td.pfc_td2 {
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/pfc_words.png');
?>");
  background-repeat: no-repeat;
  padding-left: 5px;
}
...
input#pfc_send {
  ...
  cursor: pointer;
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/pfc_send.png');
?>");
  cursor: pointer;
}
