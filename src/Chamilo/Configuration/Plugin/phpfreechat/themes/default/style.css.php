...
div#pfc_container img, div#pfc_container div {
  behavior: url("<?php
echo $c->getFileUrlFromTheme('iepngfix.htc');
?>");
}
...
/*  height: 100%;*/
  ...
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/online-separator.gif');
?>");
...
div.pfc_message {
  margin: 0; padding: 0;
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/newmsg.gif');
?>");
  background-position: right;
...
div.pfc_oldmsg {
  background-image: url("<?php
echo $c->getFileUrlFromTheme('images/oldmsg.gif');
?>");
  background-position: right;
  background-repeat: no-repeat; 
}
