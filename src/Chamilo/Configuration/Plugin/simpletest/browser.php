...
class SimpleBrowserHistory
{
    ...
    {
        $this->_dropFuture();
        array_push($this->_sequence, array('url' => $url, 'parameters' => $parameters));
        $this->_position ++;
    }
...
class SimpleBrowser
{
     ...
     * a single page.
     * Frees all of the builder memory and so
    ...
    /**
     * Fetches a page.
     * Jointly recursive with the _parse()
    ...
    function _loadPage($url, $parameters)
    {
        ...
        $this->_history->recordEntry($this->_page->getUrl(), $this->_page->getRequestData());
     ...
     * browser.
     * Will attempt to repeat the page fetch. If
    ...
    function retry()
    {
        ...
        if (count($frames) > 0)
        {
            $this->_loadFrame($frames, $this->_page->getUrl(), $this->_page->getRequestData());
            return $this->_page->getRaw();
        }
     ...
     * browser.
     * The browser history is unchanged on
    ...
    function authenticate($username, $password)
    {
        ...
        $this->_user_agent->setIdentity($url->getHost(), $this->_page->getRealm(), $username, $password);
        return $this->retry();
    }
    ...
    function clickSubmit($label = 'Submit', $additional = false)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submitButton(new SimpleByLabel($label), $additional));
    ...
    function clickSubmitByName($name, $additional = false)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submitButton(new SimpleByName($name), $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickSubmitById($id, $additional = false)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submitButton(new SimpleById($id), $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickImage($label, $x = 1, $y = 1, $additional = false)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submitImage(new SimpleByLabel($label), $x, $y, $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickImageByName($name, $x = 1, $y = 1, $additional = false)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submitImage(new SimpleByName($name), $x, $y, $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickImageById($id, $x = 1, $y = 1, $additional = false)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submitImage(new SimpleById($id), $x, $y, $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function submitFormById($id)
    {
        ...
        $success = $this->_load($form->getAction(), $form->submit());
        return ($success ? $this->getContent() : $success);
    }

    /**
     * Finds a URL by label.
     * Will find the first link
