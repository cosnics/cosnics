...
class EclipseReporter extends SimpleScorer
{
    ...
    function paintFail($message)
    {
        ...
        if (! $this->_fail && ! $this->_error)
        {
            ...
            $this->_listener->write(
                '{status:"fail",message:"' . $this->_message . '",group:"' . $this->_group . '",case:"' . $this->_case .
                     '",method:"' . $this->_method . '"}');
        }
    }

    /**
     * Stash the first error.
     * Clicking the test
    ...
    function paintError($message)
    {
        if (! $this->_fail && ! $this->_error)
        {
            ...
            $this->_message = $this->escapeVal($message);
            $this->_listener->write(
                '{status:"error",message:"' . $this->_message . '",group:"' . $this->_group . '",case:"' . $this->_case .
                     '",method:"' . $this->_method . '"}');
        }
    }

    /**
     * Stash the first exception.
     * Clicking the test
    ...
    function paintMethodEnd($method)
    {
        ...
        {
            $this->_listener->write(
                '{status:"pass",message:"' . $this->_message . '",group:"' . $this->_group . '",case:"' . $this->_case .
                     '",method:"' . $this->_method . '"}');
        }
    }
    ...
    /**
     * Stashes the name of the test suite.
