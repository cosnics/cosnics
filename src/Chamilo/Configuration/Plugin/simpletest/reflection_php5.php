...
class SimpleReflection
{
     ...
     * interface.
     * 
     * @return s array List of method names.
     * @access public
     */
    function getMethods()
    {
     ...
     * 
     * @return s array List of interfaces.
     * @access public
     */
     ...
     * interfaces only.
     * 
     * @return s array List of enforced method signatures.
     * @access public
     */
     ...
     * @return s boolean True if enforced.
     * @access private
     */
     ...
     * 
     * @return s string Parent class name.
     * @access public
     */
    function getParent()
    {
     ...
     * 
     * @return s boolean True if abstract.
     * @access public
     */
    function isAbstract()
    {
     ...
     * 
     * @return s boolean True if interface.
     * @access public
     */
     ...
     * 
     * @return s boolean True if the class has a final method.
     * @access public
     */
    function hasFinal()
    {
     ...
     *        to reduce.
     * @return s array List of parent interface names.
     * @access private
     */
    ...
    function getSignature($name)
    {
        ...
        if ($this->_isInterfaceMethod($name) || $this->_isAbstractMethod($name) ||
             $this->_isAbstractMethodInParents($name) || $this->_isStaticMethod($name))
        {
    ...
    function _getFullSignature($name)
    {
        ...
        return "{$static}function $reference$name(" . implode(', ', $this->_getParameterSignatures($method)) . ")";
    }
