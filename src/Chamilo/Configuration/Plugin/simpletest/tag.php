...
class SimpleTag
{
     ...
     * itself as it's searchable page content.
     * Private
...
class SimpleTextAreaTag extends SimpleWidget
{
     ...
     * this tag.
     * There is strange behaviour in this
...
class SimpleUploadTag extends SimpleWidget
{
    ...
    function write(&$encoding)
    {
        ...
        $encoding->attach($this->getName(), implode('', file($this->getValue())), basename($this->getValue()));
    }
}
