...
class SimpleTest
{
     ...
     * not be run.
     * Once PHP4 is dropped this will disappear
     ...
     * all parent classes to the list.
     * If a class
    ...
    /**
     * Retrieves 'preferred' objects from global pool.
     * Class filter
     ...
     * list.
     * Quite obviously the ignore list should
 ...
 * test run.
 * Makes things like error queues
