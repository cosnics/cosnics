...
/**
 * Basic test case.
 * This is the smallest unit of a test
...
class SimpleTestCase
{
     ...
     * be run.
     * Currently any method that starts with 'test'
    ...
    function pass($message = "Pass")
    {
        ...
        $this->_reporter->paintPass($message . $this->getAssertionLine());
        return true;
    }
    ...
    function fail($message = "Fail")
    {
        ...
        $this->_reporter->paintFail($message . $this->getAssertionLine());
        return false;
    }
...
class SimpleFileLoader
{
    ...
    /**
     * Calculates the incoming test cases.
     * Skips abstract
     * and ignored classes.
     * 
...
class BadTestSuite
{
    ...
    {
        $reporter->paintGroupStart($this->getLabel(), $this->getSize());
        $reporter->paintFail('Bad TestSuite [' . $this->getLabel() . '] with error [' . $this->_error . ']');
        $reporter->paintGroupEnd($this->getLabel());
        return $reporter->getStatus();
    }
