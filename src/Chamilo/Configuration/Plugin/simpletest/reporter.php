<?php
use libraries\format\structure\BreadcrumbTrail;
use libraries\format\structure\Breadcrumb;
...
class HtmlReporter extends SimpleReporter
{
    ...
    function paintHeader($test_name)
    {
        ...
        BreadcrumbTrail :: get_instance()->add(new Breadcrumb('#', 'Test Suite'));
        BreadcrumbTrail :: get_instance()->add(new Breadcrumb('#', $test_name));
    ...
    function _getCss()
    {
        return ".fail { background-color: inherit; color: red; }" . ".pass { background-color: inherit; color: green; }" .
    ...
    function paintFooter($test_name)
    {
        ...
        echo '<tbody>';
        echo '<tr>';
        echo '<td>Passes</td><td>' . $this->getPassCount() . '</td>';
        echo '</tr>';
        echo '<tr class="row_odd">';
        echo '<td>Fails</td><td>' . $this->getFailCount() . '</td>';
        echo '</tr>';
        echo '<tr>';
        echo '<td>Exceptions</td><td>' . $this->getExceptionCount() . '</td>';
        echo '</tr>';
        echo '</tbody>';
        echo '</table>';
    ...
    function paintFail($message)
    {
        ...
        print "<div class=\"error-message\"><span class=\"fail\">Fail</span>: ";
        $breadcrumb = $this->getTestList();
        array_shift($breadcrumb);
        print implode("<br />- ", $breadcrumb);
        print '<br />';
        print "- " . $this->_htmlEntities($message) . "<br /></div>\n";
    }
    ...
    function paintException($exception)
    {
        ...
        array_shift($breadcrumb);
        print implode(" -&gt; ", $breadcrumb);
        $message = 'Unexpected exception of type [' . get_class($exception) . '] with message [' .
...
class TextReporter extends SimpleReporter
{
    ...
    function paintFooter($test_name)
    {
        ...
        print 
            "Test cases run: " . $this->getTestCaseProgress() . "/" . $this->getTestCaseCount() . ", Passes: " .
                 $this->getPassCount() . ", Failures: " . $this->getFailCount() . ", Exceptions: " .
