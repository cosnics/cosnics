...
/**
 * Cookie data holder.
 * Cookie rules are full of pretty
...
class SimpleCookie
{
     ...
     * there.
     * The test path must be longer or
    ...
    {
        return (strncmp($this->_fixPath($path), $this->getPath(), strlen($this->getPath())) == 0);
    }
...
class SimpleCookieJar
{
     ...
     * browser cookies.
     * Looks for the longest path that
     * matches.
     * 
