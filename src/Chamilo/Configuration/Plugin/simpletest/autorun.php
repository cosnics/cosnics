 ...
 * so far been run.
 * Uses the DefaultReporter which can have
...
/**
 * Just the classes from the first autorun script.
 * May
...
function capture_new_classes()
{
    ...
    return array_map(
        ...
        array_diff(
            ...
            $SIMPLETEST_AUTORUNNER_INITIAL_CLASSES ? $SIMPLETEST_AUTORUNNER_INITIAL_CLASSES : array()));
}
?>