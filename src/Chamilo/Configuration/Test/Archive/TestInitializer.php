 ...
 * @author Systho
 */
require_once __DIR__ . '/../php/filesystem/path.class.php';
require_once __DIR__ . '/../php/utilities.class.php';
...
class TestInitializer
{
    ...
    {
        // unfortunately MDB2 is used by common/libraries and is neither STRICT nor avoiding DEPRECATED
