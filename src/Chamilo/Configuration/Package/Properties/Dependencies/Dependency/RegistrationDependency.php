...
class RegistrationDependency extends Dependency
{
    ...
    /**
     *
     * @return \Chamilo\Configuration\Package\Properties\Dependencies\Dependency\Version
     */
    ...
    public function check()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $parameters['CURRENT'] = '--' . Translation::get('InactiveObject', array(), Utilities::COMMON_LIBRARIES) .
                         '--';
                    $this->logger->add_message(
                        Translation::get('CurrentRegistrationDependency', $parameters),
                        MessageLogger::TYPE_ERROR);
